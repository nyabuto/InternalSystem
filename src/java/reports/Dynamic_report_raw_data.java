 ...
 * @author GNyabuto
 */
public class Dynamic_report_raw_data extends HttpServlet {
...
//create is validated header
                ...
                shet.setColumnWidth(headercellpos, 6000);
                XSSFCell cell2E = rw.createCell(headercellpos);
                cell2E.setCellValue("ART");
                cell2E.setCellStyle(stylex);
                headercellpos++;
                
                shet.setColumnWidth(headercellpos, 6000);
                XSSFCell cell2G = rw.createCell(headercellpos);
                cell2G.setCellValue("PMTCT");
                cell2G.setCellStyle(stylex);
                headercellpos++;
                
                shet.setColumnWidth(headercellpos, 6000);
                XSSFCell cell2F = rw.createCell(headercellpos);
...
//compare if the indicator belongs to the specified section and hence worksheet 
                        ...
                        //ART
                        XSSFCell cell2E = rw.createCell(colpos);
                        cell2E.setCellValue(conn.rs.getString("ART"));
                        cell2E.setCellStyle(stborder);
                        colpos++;
                        //PMTCT
                        XSSFCell cell2F = rw.createCell(colpos);
                        cell2F.setCellValue(conn.rs.getString("PMTCT"));
                        cell2F.setCellStyle(stborder);
                        colpos++;
                        //HTC
                        XSSFCell cell2G = rw.createCell(colpos);
                        cell2G.setCellValue(conn.rs.getString("HTC"));
                        cell2G.setCellStyle(stborder);
                        colpos++;
