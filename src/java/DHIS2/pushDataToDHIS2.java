 ...
 * @author EKaunda
 */
public class pushDataToDHIS2 extends HttpServlet {
...
public ResultSet getDistinctColumns(dbConn conn, String Formname)
{
    ArrayList  distinctcatcombos= new ArrayList(); 
        try {
            ...
            String getDistinctCatcombos="SELECT distinct(producercatcomboname) as f1acol, consumercatcomboid as khis_column FROM dhis2_businessrule  where dataset ='"+Formname+"'" ;
...
public ArrayList getDistinctF1aColumns(dbConn conn, String Formname)
{
   ArrayList imis_dhis_al= new ArrayList();
        ...
        try {
            ...
            while(conn.rs_1.next()){
              ...
              imis_dhis_al.add(conn.rs_1.getString(1)+" "+conn.rs_1.getString(2));
...
public ResultSet GetForm1aData(dbConn conn, String Yearmonth_coma_separated, String facilityid, ArrayList colnames){
    
    //We are working with Form 1a , which is our main form
    
    //in this phase, we are pulling data from three main tables namely vw_fas (which has all the data for form 1a ) subpartnera (which has data including orgunit names in ANYB KHIS instance and)
    
    
            String maintablename="vw_fas";
            ...
            String qry="Select "
                    ...
                    +"ifnull(m_uk,'0') as m_uk, "
                    +"ifnull(f_uk,'0') as f_uk, "
...
public JSONObject toJsonString (dbConn conn,ResultSet datavaluesres, ArrayList categres, String sendername) throws SQLException{
...
public JSONObject UploadF1aToServer( JSONObject jd, String user,String password ){
    ...
    System.out.println("Password ni:"+password);
        try {           
            ...
            URL url = new URL ("https://dhis-afyanyota.fhi360.org/api/dataValueSets");
