...
String allpath = getServletContext().getRealPath("/Form_1A_Tracker.xlsx");
...
String sourcepath = getServletContext().getRealPath("/Form_1A_Tracker.xlsx");
...
//    XSSFSheet shet1=wb.createSheet("Raw Data Report");
    ...
    XSSFSheet shet2= wb.getSheet("Form 1A Missing Reports");
...
//    RowHeader.setHeightInPoints(50);
        ...
        for (String ymonth : period) {
            query = "call rpt_fas_tracker("+ymonth+")";
...
//            end
           ...
           String query_summary = "call rpt_fas_tracker_general("+ymonth+")"; // only shows missing reports
...
ctTable.setRef("A1:J" + (shet2.getLastRowNum() + 1)); // adjust reference as needed
    ...
    response.setHeader("Content-Disposition", "attachment; filename=Form1A_Tracker_Report.xlsx");
