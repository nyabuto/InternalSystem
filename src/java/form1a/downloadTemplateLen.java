 ...
 * @author EKaunda
 */
public class downloadTemplateLen extends HttpServlet {
...
//_______________________ Create excel templates _________________________________________
           ...
           HashMap<String, Integer[]> hm= new HashMap< >();
            ...
            String allpath = getServletContext().getRealPath("/F1av101.xlsx");
            String allpath_beforeaug = getServletContext().getRealPath("/F1av10_prev.xlsx");
            String allpath_cxca_v7 = getServletContext().getRealPath("/F1av10_cxca.xlsx");
            ...
            String where = " and subpartnera.active=1 and lenprep=1 ";
...
if(smonth.equals(emonth)){  mwezi=emonth;  } else { mwezi=smonth+"_to_"+emonth; }
           ...
           todeletefiles+=np+"@"; 
            ...
            String sr_afteraug = getServletContext().getRealPath("/F1av101.xlsx");
            String sr_beforeaug = getServletContext().getRealPath("/F1av101_prev.xlsx");
            String sr_linkage = getServletContext().getRealPath("/F1av101_linkage.xlsx");
            String sr_cxca = getServletContext().getRealPath("/F1av101_cxca.xlsx");
 ...
 if(correction_form.equals("F1av101_linkage")){sr=sr_linkage;} 
 else if(correction_form.equals("F1av101_cxca")){sr=sr_cxca;} 
 else {
   ...
   //_______________________________________________________________         
        ...
        requiredrows= convertResultSetToArrayList(getAnyDataFromDb(conn, "call internal_system.sp_pull_data_F1a_keys_len('"+mwakamwezi+"','"+mflcode+"');"));
        hmd=convertResultSetToMap(getAnyDataFromDb(conn, "call internal_system.sp_pull_data_F1a('"+mwakamwezi+"');"));
        
                    System.out.println("call internal_system.sp_pull_data_F1a_keys_len('"+mwakamwezi+"','"+mflcode+"');");
