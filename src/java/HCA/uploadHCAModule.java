...
session.setAttribute("hcapos", "<b>"+0+"/"+1+"</b>");
                session.setAttribute("hcapos_count", (0*100)/1);
...
XSSFCell facilmfl = workbook.getSheetAt(1).getRow(0).getCell((short) 4);
String Facii=fd.getFacilityName(facilmfl.getStringCellValue(), conn);
                 //System.out.println("MFLCoode"+facilmfl+"_"+Facii+"_");
...
uploadedfiles.add(fileName);  
    ...
    //end of checking if excel file is valid
     ...
     session.setAttribute("uploadedhca","Data for Workbooks <br/>: "+fileName+". Uploaded Successfully ");
