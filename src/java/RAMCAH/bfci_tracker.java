 ...
 * @author GNyabuto
 */
public class bfci_tracker extends HttpServlet {
    HttpSession session;
...
//    RowHeader.setHeightInPoints(50);
         ...
         row=1;
            ...
            query = "call sp_rmcah_bfci_tracker('"+sd+"','"+ed+"')";
...
ctTable.setRef("A1:G" + (shet1.getLastRowNum() + 1)); // adjust reference as needed
    ...
    response.setHeader("Content-Disposition", "attachment; filename=BFCI_Tracker_Report.xlsx");
