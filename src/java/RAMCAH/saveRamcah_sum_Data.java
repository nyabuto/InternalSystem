 ...
 * @author EKaunda
 */
public class saveRamcah_sum_Data extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table="internal_system.ramcah";
 ...
 String[] dataelementsarr= {"id","yearmonth","facility_id","indicator_id","value","userid","week","orgunit"}; 
 ...
 out.println(" Data Not saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveRamcah_sum_Data.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
