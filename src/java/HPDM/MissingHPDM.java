 ...
 * @author EKaunda
 */
public class MissingHPDM extends HttpServlet {
...
//______________________________________________________________________________________  
        ...
        sps.put(1, "Unsubmited_HPDM_Reports@sp_hpdm_missing_reports");
...
rw.setHeightInPoints(32);
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "HPDM_Tracker_rpt_from_"+startdate+"_to_"+enddate+"__gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(MissingHPDM.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
