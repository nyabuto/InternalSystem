...
String output,where,query;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("subcounty")!=null){
         ...
         if(!request.getParameter("gap").equals("")){
          where = where+ " gap='"+request.getParameter("gap")+"' AND ";  
        }   
        }
        ...
        String getfacil = query= "SELECT DISTINCT(facility) AS facility FROM gaps "+where+" GROUP BY facility ORDER BY facility";
            System.out.println("facil query : "+getfacil);     
