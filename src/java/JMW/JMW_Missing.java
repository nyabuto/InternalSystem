 ...
 * @author EKaunda
 */
public class JMW_Missing extends HttpServlet {
...
//______________________________________________________________________________________  
        ...
        sps.put(1, "Missing_JMW@sp_jmw_tracker");
...
String startdate="2020-04-01";
        ...
        XSSFCell cell = rw0.createCell(0);
                    cell.setCellValue(shet.getSheetName()+" for Period  and "+enddate);
...
rw.setHeightInPoints(32);
        ...
        System.out.println("" + "JMWTracker_reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "JMW_Tracker_rpt_from_"+startdate+"_to_"+enddate+"__gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(JMW_Missing.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
