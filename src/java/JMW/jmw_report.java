 ...
 * @author EKaunda
 */
public class jmw_report extends HttpServlet {
...
//______________________________________________________________________________________  
        ...
        sps.put(1, "JMW Report@sp_jmw_report");
...
String startdate="2020-04-01";
     ...
     String [] facilityarr=null;   
        ...
        String qry = "call "+storedprocedure+"('"+enddate+"');";
...
rw.setHeightInPoints(32);
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "JMW_rpt_from_"+startdate+"_to_"+enddate+"_gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(jmw_report.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
