 ...
 */
public class datimReport_jul_2016 extends HttpServlet {
HttpSession session;
...
response.setHeader("Content-Disposition", "attachment; filename=DATIM_ART_CARE_PMTCT_CREATED_ON_"+createdOn.trim()+".xls");
