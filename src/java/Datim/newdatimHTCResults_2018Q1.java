...
if(conn.rs.getString("PMTCT")!=null){staticispmtct.add(conn.rs.getString("PMTCT"));} else {staticispmtct.add("");}
    ...
    String get731data="SELECT "+
            ...
            "ROUND(SUM( CASE WHEN indicator='PMTCT_ANC' THEN (HV0206*(f_4+f_9)) end)) as pmtct_pos_1_9," +
            ...
            "ROUND(SUM( CASE WHEN indicator='PMTCT_ANC' THEN (HV0201*(f_4+f_9)) - (HV0206*(f_4+f_9)) end))  as pmtct_neg_1_9," +
            ...
            "ROUND(SUM( CASE WHEN indicator='PMTCT_STAT' THEN ((HV0201 + HV0205)*(f_1+f_4+f_9)) end)) as pmtct_statnum_tes_10," +
            ...
            "ROUND(SUM( CASE WHEN indicator='PMTCT_STAT' THEN (IFNULL(new_anc,0)*(f_1+f_4+f_9)) end)) as pmtct_statden_tes_10, " +
            ...
            "ROUND(SUM( CASE WHEN indicator='PMTCT_STAT' THEN (HV0205*(f_4+f_9)) end)) as pmtct_kp_1_9," +
