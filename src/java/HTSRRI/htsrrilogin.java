...
public class htsrrilogin extends HttpServlet {
HttpSession session;
String username,password,fname,mname,lname,userid,level,pass,fullname,status;
MessageDigest m;
String userAccess;
 ...
 conn.conn.close();
    ...
    try {
        ...
        Logger.getLogger(htsrrilogin.class.getName()).log(Level.SEVERE, null, ex);
