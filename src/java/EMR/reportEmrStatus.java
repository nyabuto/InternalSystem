 ...
 * @author EKaunda
 */
public class reportEmrStatus extends HttpServlet {
...
//______________________________________________________________________________________  
        ...
        sps.put(1, "EMR Status Report@monthly_emr_vw");
...
String startdate="2020-04-01";
     ...
     String [] facilityarr=null;   
        ...
        String qry = "select * from monthly_emr_vw where yearmonth between '"+startdate+"' and '"+enddate+"' ";
...
rw.setHeightInPoints(32);
        ...
        System.out.println("" + "EMR_Status_reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "EMR_status_rpt_from_"+startdate+"_to_"+enddate+"_gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(reportEmrStatus.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
