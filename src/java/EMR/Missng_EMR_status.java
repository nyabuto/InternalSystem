 ...
 * @author EKaunda
 */
public class Missng_EMR_status extends HttpServlet {
...
//______________________________________________________________________________________  
        ...
        sps.put(1, "Missing_EMRStatus@emrstatus_tracker");
...
rw.setHeightInPoints(32);
        ...
        System.out.println("" + "KenyaEMRTracker_reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "KenyaEMR_Tracker_rpt_from_"+startdate+"_to_"+enddate+"__gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Missng_EMR_status.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
