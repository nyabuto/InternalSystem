 ...
 */
public class savehts extends HttpServlet {
...
String Insertqr= "insert into hts  set SubPartnerID='"+facil+"',Annee='"+year+"',Mois='"+month+"', "+col+"="+achieved+" , tableid='"+tableid+"' , user_id='"+userid+"' , yearmonth='"+yearmonth+"' , isValidated='0' , sdp='"+sdp+"'";
    String updateqr="update hts set "+col+"="+achieved+" , isValidated='0' where tableid='"+tableid+"'";
//check whether data for that month, year and facility has been saved

String checker="select "+col+" from hts where tableid='"+tableid+"'";
