...
//     unvalidatedLink+="<a href=\"changeFacilitySession?facilityID="+conn.rs.getString(1)+"&&src=Form731.jsp\">"+counter+". "+conn.rs.getString(2)+"</a><br><br>" ;   
 ...
 String label="Record counter <font color='white'><b>"+kmmpdone+"<b></font>  out of <b>"+facilssupporting+"</b>"+validated+unvalidated;
	...
	+ "<tr>"
        ...
        + "<td><input type=\"text\" name=\"v2_pc_s_44y\" id=\"v2_pc_s_44y\" value=\""+v2_pc_s_44y+"\" onblur=\"autosave('v2_pc_s_44y');\"  oninput=\"v2_pc('v2_pc_s_44y'); \" class=\"data-cell\" data-toggle=\"tooltip\"  "+lock+"  data-placement=\"right\" autocomplete=\"off\" maxLength=\"6\" onkeypress=\"return numbers(event)\" ></td>"
