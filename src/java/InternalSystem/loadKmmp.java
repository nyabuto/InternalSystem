...
if(HV0206==null){HV0206=""; }
    ...
    createdtable+=enterdby+"<fieldset class=\"formatter\"><legend class=\"formatter\"><b style=\"text-align:center;\"> KMMP OUTPUT DATA</b></legend><table  cellpadding=\"2px\" border=\"0\" style=\"border-color: #e5e5e5;margin-bottom: 3px;\"><tr class='form-actions'><th colspan='2'><b></b></th><th>Total</th></tr><tr><td><b> 1 </b></td><td colspan='2'>No of New HIV positive clients enrolled in KMMP Services (ANC and PN) </td><td><input type='text' onclick=\"this.select();\" onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('KMMP1','"+tableid+"');\" value='"+KMMP1+"' name='KMMP1' id='KMMP1' ></td></tr>";
    
    createdtable+="<tr><td><b> 2 </b></td><td colspan='2'>No of New HIV negative clients enrolled in KMMP Services (ANC Only) </td><td><input type='text' onclick=\"this.select();\" onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('KMMP2','"+tableid+"');\" value='"+KMMP2+"' name='KMMP1' id='KMMP2'></td></tr>";
    
    createdtable+="<tr><td rowspan='3'><b> 3 </b></td><td colspan='2'> a) No. of HIV-positive pregnant women enrolled in KMMP Services </td><td><input type='text' onclick=\"this.select();\" onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"showpercent();autosave('KMMP3a','"+tableid+"');\" value='"+KMMP3a+"' name='KMMP3a' id='KMMP3a'></td></tr>";
    
    createdtable+="<tr><td colspan='2'>  b) Total number of HIV-positive pregnant women in facility (New positive and Known Positive-MOH731) </td><td><input type='text' onclick=\"this.select();\" onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"showpercent();autosave('KMMP3b','"+tableid+"');\" value='"+KMMP3b+"' name='KMMP3b' id='KMMP3b'></td></tr>";
    ...
    createdtable+="<tr><td ><b> 4 </b></td><td colspan='2'>No. of KMMP support group sessions held </td><td><input type='text' onclick=\"this.select();\" onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('KMMP4','"+tableid+"');\" value='"+KMMP4+"' name='KMMP4' id='KMMP4'></td></tr>";
     
    createdtable+="<tr><td rowspan='3'><b> 5 </b></td><td rowspan='3'>Defaulter Tracing </td><td>New Defaulted Clients </td><td><input type='text' onclick=\"this.select();\" onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('KMMP5a','"+tableid+"');\" value='"+KMMP5a+"' name='KMMP5a' id='KMMP5a'></td></tr>";
     
    createdtable+="<tr><td>Clients Reached</td><td><input type='text' onclick=\"this.select();\" autocomplete=\"off\"  onblur=\"autosave('KMMP5b','"+tableid+"');\" value='"+KMMP5b+"' onkeypress=\"return numbers(event,this);\" name='KMMP5b' id='KMMP5b'></td></tr>";
