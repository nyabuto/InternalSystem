...
//   end of reading data from old 731 done 14th march 2018
    ...
    createdtable+="<tr><td><b> 2 </b></td><td colspan='2'>No of New HIV negative clients enrolled in KMMP Services (ANC Only) </td><td><input type='text' onclick=\"this.select();\" onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('KMMP2','"+tableid+"');\" value='"+KMMP2+"' name='KMMP2' id='KMMP2'></td></tr>";
    
    createdtable+="<tr><td rowspan='3'><b> 3 </b></td><td colspan='2'> a) No. of HIV-positive pregnant women enrolled in KMMP Services </td><td><input type='text' onclick=\"this.select();\" onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('KMMP3a','"+tableid+"');showpercent();\" value='"+KMMP3a+"' name='KMMP3a' id='KMMP3a'></td></tr>";
    
    createdtable+="<tr><td colspan='2'>  b) Total number of HIV-positive pregnant women in facility (New positive and Known Positive-MOH731) </td><td><input type='text' onclick=\"this.select();\" onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('KMMP3b','"+tableid+"');showpercent();\" value='"+KMMP3b+"' name='KMMP3b' id='KMMP3b'></td></tr>";
