 ...
 */
public class savesgbv extends HttpServlet {
...
String Insertqr= "insert into sgbv  set SubPartnerID='"+facil+"',Annee='"+year+"',Mois='"+month+"', "+col+"="+achieved+" , id='"+tableid+"' , userid='"+userid+"' , yearmonth='"+yearmonth+"' , isValidated='0'";
    String updateqr="update sgbv set "+col+"="+achieved+" , isValidated='0' where id='"+tableid+"'";
//check whether data for that month, year and facility has been saved

String checker="select "+col+" from sgbv where id='"+tableid+"'";
...
//a code to loop through all synced records without a quarter
 ...
 out.println(error);
        ...
        out.close();
            ...
            Logger.getLogger(savesgbv.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
