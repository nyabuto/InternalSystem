 ...
 * @author GNyabuto
 */
public class save733B extends HttpServlet {
HttpSession session;
String output="";
...
String Insertqr= "insert into moh733b  set SubPartnerID='"+facilityID+"',Annee='"+year+"',Mois='"+month+"', "+columnName+"="+value+" , id='"+tableid+"' , user_id='"+userid+"', yearmonth='"+yearmonth+"',quarter='"+quarter+"'";
String updateqr="update moh733b set "+columnName+"="+value+",isValidated='0', yearmonth='"+yearmonth+"' where id='"+tableid+"'";
...
System.out.println("error : "+error);
 out.println(error);
    ...
    try {
        ...
        Logger.getLogger(save733B.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
