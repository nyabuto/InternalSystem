...
if(C51DT==null){C51DT=""; }
    ...
    createdtable+="<tr><td colspan='5'><b>Number of Community health workers trained in child health and/or nutrition</b></td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('MCHNtrnCHWTrain');\" value='"+MCHNtrnCHWTrain+"' name='MCHNtrnCHWTrain' id='MCHNtrnCHWTrain' ></td></tr>";
    createdtable+="<tr><td colspan='5'><b>Number of children reached by USG-supported nutrition programs</b></td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('MCHNutChRch');\" value='"+MCHNutChRch+"' name='MCHNutChRch' id='MCHNutChRch' ></td></tr>";
    createdtable+="<tr><td colspan='5'>Total number of children under five who are wasted (with weight for height Z score < - 2)</td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('MCHNtrnWasted');\" value='"+MCHNtrnWasted+"' name='MCHNtrnWasted' id='MCHNtrnWasted' ></td></tr>";
    createdtable+="<tr><td colspan='5'>Total number of children under five who are underweight (with weight for age Z score < - 2) (SEE Indicator </td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('MCHNtrnUnderweight');\" value='"+MCHNtrnUnderweight+"' name='MCHNtrnUnderweight' id='MCHNtrnUnderweight' ></td></tr>";
    createdtable+="<tr><td colspan='5'>Total number of children under five years</td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('MCHChild5D');\" value='"+MCHChild5D+"' name='MCHChild5D' id='MCHChild5D' ></td></tr>";
    createdtable+="<tr><td colspan='5'>Number of health facilities with established capacity to manage acute under-nutrition</td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('MCHNtrnHealthFacility');\" value='"+MCHNtrnHealthFacility+"' name='MCHNtrnHealthFacility' id='MCHNtrnHealthFacility' ></td></tr>";
    ...
    createdtable+="</table></fieldset><fieldset class='formatter'><legend class='formatter'><b style='text-align:center;'>HIV and Nutrition </b></legend><table  cellpadding='2px' border='0' style='border-color: #e5e5e5;margin-bottom: 3px;'>"
            + "<tr><td></td> <td colspan='6'> <b>Number of children under 5 years of age who received Vitamin A from USG-supported programs</b> </td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('MCHVaccVitA');\" value='"+MCHVaccVitA+"' name='MCHVaccVitA' id='MCHVaccVitA' ></td></tr>";
    createdtable+="<tr><td rowspan='3' colspan='2'><b>C2.3.D</b></td><td colspan='5'>Number of HIV – positive clinically malnourished clients who received therapeutic and/or supplementary food < 18</td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('MCHNtrnFoodOVC');c23dtotal();\" value='"+MCHNtrnFoodOVC+"' name='MCHNtrnFoodOVC' id='MCHNtrnFoodOVC' ></td></tr>";
    createdtable+="<tr><td colspan='5'>Number of HIV – positive clinically malnourished clients who received therapeutic and/or supplementary food 18+ (PLHIV)</td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('MCHNtrnFoodPLHIV');c23dtotal();\" value='"+MCHNtrnFoodPLHIV+"' name='MCHNtrnFoodPLHIV' id='MCHNtrnFoodPLHIV' ></td></tr>";
    createdtable+="<tr><td colspan='5'>Number of HIV – positive clinically malnourished clients who received therapeutic and/or supplementary food -<b> Total</b></td><td><input readonly tabindex='-1'  style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('MCHNtrnFood');\" value='"+MCHNtrnFood+"' name='MCHNtrnFood' id='MCHNtrnFood' ></td></tr>";
    createdtable+="<tr><td></td><td colspan='4'></td><td><b>Male</b></td><td><b>Female</b></td><td><b>Total</b></td></tr>";
    createdtable+="<tr><td rowspan='4' colspan='2'> <b>C5.1.D</b></td><td colspan='2' rowspan='4'>Number of eligible clients who received food and / or other nutrition Services</td><td> <b><18</b> </td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('C51DCM');c51dtotal();\" value='"+C51DCM+"' name='C51DCM' id='C51DCM' ></td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('C51DCF');c51dtotal();\" value='"+C51DCF+"' name='C51DCF' id='C51DCF' ></td><td><input readonly tabindex='-1' style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\"  value='"+C51DC+"' name='C51DC' id='C51DC' ></td></tr>";
    createdtable+="<tr><td> <b> >=18</b> </td><td><input tabindex='-1' readonly style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\"  value='"+C51DAM+"' name='C51DAM' id='C51DAM' ></td><td><input tabindex='-1' readonly style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('C51DAF');c51dtotal();\" value='"+C51DAF+"' name='C51DAF' id='C51DCF' ></td><td><input tabindex='-1' readonly style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\"  value='"+C51DA+"' name='C51DA' id='C51DA' ></td></tr>";
    createdtable+="<tr><td colspan='3'> <b> Pregnant/Lactating (PMTCT 1.5)</b> </td><td><input style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('C51DP');\" value='"+C51DP+"' name='C51DP' id='C51DP' ></td></tr>";
    createdtable+="<tr><td> <b> Total</b> </td><td><input tabindex='-1' readonly style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\"  value='"+C51DMT+"' name='C51DMT' id='C51DMT' ></td><td><input tabindex='-1' readonly style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\"  value='"+C51DFT+"' name='C51DFT' id='C51DFT' ></td><td><input tabindex='-1' readonly style='width:100px;' type='text'  onclick=\"this.select();\"  onkeypress=\"return numbers(event,this);\" autocomplete=\"off\"  onblur=\"autosave('C51DT');\" value='"+C51DT+"' name='C51DT' id='C51DT' ></td></tr>"
