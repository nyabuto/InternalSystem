...
//FPIMPLANTSRemoval="";"
      FamilyPlanninng=""
              ...
              + "<td ><input type=\"text\" name=\"FPMicrolutN\" id=\"FPMicrolutN\" value=\""+FPMicrolutN+"\" autocomplete=\"off\"  onblur=\"autosave('FPMicrolutN');Microluttotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" name=\"FPMicrolutR\" id=\"FPMicrolutR\" value=\""+FPMicrolutR+"\" autocomplete=\"off\"  onblur=\"autosave('FPMicrolutR');Microluttotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" tabindex='-1' readonly name=\"FPMicrolutT\" id=\"FPMicrolutT\" value=\""+FPMicrolutT+"\" autocomplete=\"off\"  onblur=\"autosave('FPMicrolutT');Microluttotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
         
              + "<tr>"
//              + "<td>2</td>"
//              + "<td >PILLS</td>"
              + "<td  >MICROGYNON</td>"
              + "<td ><input type=\"text\" name=\"FPMicrogynonN\" id=\"FPMicrogynonN\" value=\""+FPMicrogynonN+"\" autocomplete=\"off\"  onblur=\"autosave('FPMicrogynonN');FPMicrogynon();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" name=\"FPMicrogynonR\" id=\"FPMicrogynonR\" value=\""+FPMicrogynonR+"\" autocomplete=\"off\"  onblur=\"autosave('FPMicrogynonR');FPMicrogynon();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" tabindex='-1' readonly name=\"FPMicrogynonT\" id=\"FPMicrogynonT\" value=\""+FPMicrogynonT+"\" autocomplete=\"off\"  onblur=\"autosave('FPMicrogynonT');FPMicrogynon();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
              
              + "<tr><td>2</td>"
              + "<td >INJECTIONS</td>"
              + "<td  >INJECTIONS</td>"
              + "<td ><input type=\"text\" name=\"FPINJECTIONSN\" id=\"FPINJECTIONSN\"  value=\""+FPINJECTIONSN+"\" autocomplete=\"off\"  onblur=\"autosave('FPINJECTIONSN');FPInjectionsTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" name=\"FPINJECTIONSR\" id=\"FPINJECTIONSR\"  value=\""+FPINJECTIONSR+"\" autocomplete=\"off\"  onblur=\"autosave('FPINJECTIONSR');FPInjectionsTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" tabindex='-1' readonly name=\"FPINJECTIONST\" id=\"FPINJECTIONST\"  value=\""+FPINJECTIONST+"\" autocomplete=\"off\"  onblur=\"autosave('FPINJECTIONST');FPInjectionsTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
              ...
              + "<td >I.U.C.D.</td>"
              + "<td  >Insertion</td>"
              + "<td ><input type=\"text\" name=\"FPIUCDN\" id=\"FPIUCDN\" value=\""+FPIUCDN+"\" autocomplete=\"off\"  onblur=\"autosave('FPIUCDN');FPIUCDTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" name=\"FPIUCDR\" id=\"FPIUCDR\" value=\""+FPIUCDR+"\" autocomplete=\"off\"  onblur=\"autosave('FPIUCDR');FPIUCDTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\"  tabindex='-1' readonly name=\"FPIUCDT\" id=\"FPIUCDT\" value=\""+FPIUCDT+"\" autocomplete=\"off\"  onblur=\"autosave('FPIUCDT');FPIUCDTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
              
              + "<tr><td>4</td>"
              + "<td >IMPLANTS</td><td  >Insertion</td>"
              + "<td ><input type=\"text\" name=\"FPIMPLANTSN\" id=\"FPIMPLANTSN\" value=\""+FPIMPLANTSN+"\" autocomplete=\"off\"  onblur=\"autosave('FPIMPLANTSN');FPIMPLANTSTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" name=\"FPIMPLANTSR\" id=\"FPIMPLANTSR\" value=\""+FPIMPLANTSR+"\" autocomplete=\"off\"  onblur=\"autosave('FPIMPLANTSR');FPIMPLANTSTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" tabindex='-1' readonly  name=\"FPIMPLANTST\" id=\"FPIMPLANTST\" value=\""+FPIMPLANTST+"\" autocomplete=\"off\"  onblur=\"autosave('FPIMPLANTST');FPIMPLANTSTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
              
              + "<tr><td rowspan=\"2\">5</td>"
              + "<td  rowspan=\"2\">STERILIZATION</td><td  >B.T.L</td>"
              + "<td ><input type=\"text\" name=\"FPBTLN\" id=\"FPBTLN\" value=\""+FPBTLN+"\" autocomplete=\"off\"  onblur=\"autosave('FPBTLN');FPBTLTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" name=\"FPBTLR\" tabindex='-1' readonly id=\"FPBTLR\" value=\""+FPBTLR+"\" autocomplete=\"off\"  onblur=\"autosave('FPBTLR');FPBTLTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" tabindex='-1' name=\"FPBTLT\" readonly id=\"FPBTLT\" value=\""+FPBTLT+"\" autocomplete=\"off\"  onblur=\"autosave('FPBTLT');FPBTLTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
              + "<tr>"
              + "<td  >Vasectomy</td>"
              + "<td ><input type=\"text\" name=\"FPVasectomyN\" id=\"FPVasectomyN\" value=\""+FPVasectomyN+"\" autocomplete=\"off\"  onblur=\"autosave('FPVasectomyN');FPVasectomyTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" name=\"FPVasectomyR\" tabindex='-1' readonly  id=\"FPVasectomyR\" value=\""+FPVasectomyR+"\" autocomplete=\"off\"  onblur=\"autosave('FPVasectomyR');FPVasectomyTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" tabindex='-1' readonly name=\"FPVasectomyT\" id=\"FPVasectomyT\" value=\""+FPVasectomyT+"\" autocomplete=\"off\"  onblur=\"autosave('FPVasectomyT');FPVasectomyTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
                 + "<tr><td>6</td>"
              + "<td >CONDOMS</td><td  >No. of clients receiving</td>"
              + "<td ><input type=\"text\" name=\"FPCONDOMSN\" id=\"FPCONDOMSN\" value=\""+FPCONDOMSN+"\" autocomplete=\"off\"  onblur=\"autosave('FPCONDOMSN');FPCONDOMSTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" name=\"FPCONDOMSR\" id=\"FPCONDOMSR\" value=\""+FPCONDOMSR+"\" autocomplete=\"off\"  onblur=\"autosave('FPCONDOMSR');FPCONDOMSTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" tabindex='-1' readonly name=\"FPCONDOMST\" id=\"FPCONDOMST\" value=\""+FPCONDOMST+"\" autocomplete=\"off\"  onblur=\"autosave('FPCONDOMST');FPCONDOMSTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
                 + "<tr><td>7</td>"
              + "<td >ALL OTHERS :(Specify)</td>"
              + "<td  ></td>"
              + "<td ><input type=\"text\" name=\"FPOTHERN\" id=\"FPOTHERN\" value=\""+FPOTHERN+"\" autocomplete=\"off\"  onblur=\"autosave('FPOTHERN');FPOTHERTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" name=\"FPOTHERR\" id=\"FPOTHERR\" value=\""+FPOTHERR+"\" autocomplete=\"off\"  onblur=\"autosave('FPOTHERR');FPOTHERTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\"tabindex='-1'  readonly name=\"FPOTHERT\" id=\"FPOTHERT\" value=\""+FPOTHERT+"\" autocomplete=\"off\"  onblur=\"autosave('FPOTHERT');FPOTHERTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
              
                 + "<tr><td>8</td>"
              + "<td >TOTAL NO. OF CLIENTS</td>"
              + "<td  ></td>"
              + "<td ><input type=\"text\"  tabindex='-1' readonly name=\"FPCLIENTSN\" id=\"FPCLIENTSN\" value=\""+FPCLIENTSN+"\" autocomplete=\"off\"  onblur=\"autosave('FPCLIENTSN');FPCLIENTSTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" tabindex='-1' readonly name=\"FPCLIENTSR\" id=\"FPCLIENTSR\" value=\""+FPCLIENTSR+"\" autocomplete=\"off\"  onblur=\"autosave('FPCLIENTSR');FPCLIENTSTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td ><input type=\"text\" tabindex='-1'  readonly name=\"FPCLIENTST\" id=\"FPCLIENTST\" value=\""+FPCLIENTST+"\" autocomplete=\"off\"  onblur=\"autosave('FPCLIENTST');FPCLIENTSTotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
                 + "<tr><td>9</td>"
              + "<td >REMOVALS</td>"
              + "<td  > IUCD </td>"
              + "<td ><input type=\"text\" name=\"FPIUCDRemoval\" id=\"FPIUCDRemoval\" value=\""+FPIUCDRemoval+"\" autocomplete=\"off\"  onblur=\"autosave('FPIUCDRemoval');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "<td >IMPLANTS</td>"
              + "<td ><input type=\"text\" name=\"FPIMPLANTSRemoval\" id=\"FPIMPLANTSRemoval\" value=\""+FPIMPLANTSRemoval+"\" autocomplete=\"off\"  onblur=\"autosave('FPIMPLANTSRemoval');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr></table></fieldset>" ;
...
pmct+="";
           pmct+= "<fieldset class=\"formatter\"><legend class=\"formatter\"><b style=\"text-align:center;\"> B: MCH-ANC/PMTCT </b></legend>"
              ...
              + "<td>1.</td><td >No of ANC Clients</td>"
                   + "<td ><input type=\"text\" name=\"PMCTA_1stVisit_ANC\" id=\"PMCTA_1stVisit_ANC\" value=\""+PMCTA_1stVisit_ANC+"\" autocomplete=\"off\"  onblur=\"autosave('PMCTA_1stVisit_ANC');anctotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
                   + "<td ><input type=\"text\" name=\"PMCTA_ReVisit_ANC\" id=\"PMCTA_ReVisit_ANC\" value=\""+PMCTA_ReVisit_ANC+"\" autocomplete=\"off\"  onblur=\"autosave('PMCTA_ReVisit_ANC');anctotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
                   + "<td ><input type=\"text\" name=\"PMCTANCClientsT\" readonly id=\"PMCTANCClientsT\" value=\""+PMCTANCClientsT+"\" autocomplete=\"off\"  onblur=\"autosave('PMCTANCClientsT');anctotal();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + " <td>2.</td>   <td > No of clients with Hb <7 g/dl </td>"
                   + "<td ><input type=\"text\" name=\"PMCTHB7\" id=\"PMCTHB7\" value=\""+PMCTHB7+"\" autocomplete=\"off\"  onblur=\"autosave('PMCTHB7');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "  <td>3.</td>  <td > No of clients given IPT (1st Dose) </td>"
                   + "<td ><input type=\"text\" name=\"PMCTIPT1\" id=\"PMCTIPT1\" value=\""+PMCTIPT1+"\" autocomplete=\"off\"  onblur=\"autosave('PMCTIPT1');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "   <td>4.</td> <td > No of clients given IPT (2nd Dose) </td>"
                   + "<td ><input type=\"text\" name=\"PMCTIPT2\" id=\"PMCTIPT2\" value=\""+PMCTIPT2+"\" autocomplete=\"off\"  onblur=\"autosave('PMCTIPT2');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "<td>5.</td>    <td > No of clients completed 4th Antenatal Visit </td>"
                   + "<td ><input type=\"text\" name=\"PMCTANCClients4\" id=\"PMCTANCClients4\" value=\""+PMCTANCClients4+"\" autocomplete=\"off\"  onblur=\"autosave('PMCTANCClients4');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "<tr>"
               + "   <td>6.</td> <td > No of ITNs distributed to ANC Clients </td>"
                   + "<td ><input type=\"text\" name=\"PMCTITN\" id=\"PMCTITN\" value=\""+PMCTITN+"\" autocomplete=\"off\"  onblur=\"autosave('PMCTITN');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr></table></fieldset>"
     ...
     maternity+= "<fieldset class=\"formatter\"><legend class=\"formatter\"><b style=\"text-align:center;\"> C: MATERNITY / SAFE DELIVERIES </b></legend>"+
             "<table frame=\"box\" cellpadding=\"2px\" style=\"border-color: #e5e5e5;margin-bottom: 3px; margin-left:150px; width:800px;\"><tr>"
              ...
              + "<td>1.</td><td >Normal Deliveries </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATNormalDelivery\" id=\"MATNormalDelivery\" value=\""+MATNormalDelivery+"\" autocomplete=\"off\"  onblur=\"autosave('MATNormalDelivery');maternitytotals();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + " <td>2.</td>   <td > Caesarian Sections </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATCSection\" id=\"MATCSection\" value=\""+MATCSection+"\" autocomplete=\"off\"  onblur=\"autosave('MATCSection');maternitytotals();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "  <td>3.</td>  <td > Breech Delivery </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATBreech\" id=\"MATBreech\" value=\""+MATBreech+"\" autocomplete=\"off\"  onblur=\"autosave('MATBreech');maternitytotals();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "   <td>4.</td> <td > Assisted vaginal delivery </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATAssistedVag\" id=\"MATAssistedVag\" value=\""+MATAssistedVag+"\" autocomplete=\"off\"  onblur=\"autosave('MATAssistedVag');maternitytotals();\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "<td>5.</td>    <td > TOTAL DELIVERIES</td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATDeliveryT\" id=\"MATDeliveryT\" value=\""+MATDeliveryT+"\" autocomplete=\"off\"  onblur=\"autosave('MATDeliveryT');\" readonly   tabindex='-1' maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               
               + "<tr>"
               + "   <td>6.</td> <td > Live Births </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATLiveBirth\" id=\"MATLiveBirth\" value=\""+MATLiveBirth+"\" autocomplete=\"off\"  onblur=\"autosave('MATLiveBirth');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "   <td>7.</td> <td > Still Births </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATStillBirth\" id=\"MATStillBirth\" value=\""+MATStillBirth+"\" autocomplete=\"off\"  onblur=\"autosave('MATStillBirth');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "   <td>8.</td> <td > Under Weight Babies (Weight below 2500 grams) </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATWeight2500\" id=\"MATWeight2500\" value=\""+MATWeight2500+"\" autocomplete=\"off\"  onblur=\"autosave('MATWeight2500');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "   <td>9.</td> <td > Pre-Term babies  </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATPreTerm\" id=\"MATPreTerm\" value=\""+MATPreTerm+"\" autocomplete=\"off\"  onblur=\"autosave('MATPreTerm');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "   <td>10.</td> <td > No of babies discharged alive </td>"
                   + "<td style=\"padding-right:20px;\" colspan=\"2\" ><input type=\"text\" name=\"MATDischargealive\" id=\"MATDischargealive\" value=\""+MATDischargealive+"\" autocomplete=\"off\"  onblur=\"autosave('MATDischargealive');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "   <td>11.</td> <td > Referrals </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATReferral\" id=\"MATReferral\" value=\""+MATReferral+"\" autocomplete=\"off\"  onblur=\"autosave('MATReferral');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "   <td>12.</td> <td > Neonatal Deaths </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATNeoNatalD\" id=\"MATNeoNatalD\" value=\""+MATNeoNatalD+"\" autocomplete=\"off\"  onblur=\"autosave('MATNeoNatalD');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
               + "   <td>13.</td> <td  > Maternal Deaths </td>"
                   + "<td  colspan=\"2\"><input type=\"text\" name=\"MATMaternalD\" id=\"MATMaternalD\" value=\""+MATMaternalD+"\" autocomplete=\"off\"  onblur=\"autosave('MATMaternalD');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
               + "<tr>"
              ...
              + "<tr>"
               + "   <td>14.</td> <td > A.P.H. (Ante Partum Haemorrhage) </td>"
                   + "<td ><input type=\"text\" name=\"MATAPHAlive\" id=\"MATAPHAlive\" value=\""+MATAPHAlive+"\" autocomplete=\"off\"  onblur=\"autosave('MATAPHAlive');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
                   + "<td ><input type=\"text\" name=\"MATAPHDead\" id=\"MATAPHDead\" value=\""+MATAPHDead+"\" autocomplete=\"off\"  onblur=\"autosave('MATAPHDead');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
             + ""
              + "<tr>"
               + "   <td>15.</td> <td > P.P.H. (Post Partum Haemorrhage) </td>"
                   + "<td ><input type=\"text\" name=\"MATPPHAlive\" id=\"MATPPHAlive\" value=\""+MATPPHAlive+"\" autocomplete=\"off\"  onblur=\"autosave('MATPPHAlive');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
                   + "<td ><input type=\"text\" name=\"MATPPHDead\" id=\"MATPPHDead\" value=\""+MATPPHDead+"\" autocomplete=\"off\"  onblur=\"autosave('MATPPHDead');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
              + "<tr>"
               + "   <td>16.</td> <td > Eclampsia</td>"
                   + "<td ><input type=\"text\" name=\"MATEclampAlive\" id=\"MATEclampAlive\" value=\""+MATEclampAlive+"\" autocomplete=\"off\"  onblur=\"autosave('MATEclampAlive');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
                   + "<td ><input type=\"text\" name=\"MATEclampDead\" id=\"MATEclampDead\" value=\""+MATEclampDead+"\" autocomplete=\"off\"  onblur=\"autosave('MATEclampDead');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
              + "<tr>"
               + "   <td>17.</td> <td > Ruptured Uterus</td>"
                   + "<td ><input type=\"text\" name=\"MATRupUtAlive\" id=\"MATRupUtAlive\" value=\""+MATRupUtAlive+"\" autocomplete=\"off\"  onblur=\"autosave('MATRupUtAlive');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
                   + "<td ><input type=\"text\" name=\"MATRupUtDead\" id=\"MATRupUtDead\" value=\""+MATRupUtDead+"\" autocomplete=\"off\"  onblur=\"autosave('MATRupUtDead');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
              + "<tr>"
               + "   <td>18.</td> <td > Obstructed Labour</td>"
                   + "<td ><input type=\"text\" name=\"MATObstrLaborAlive\" id=\"MATObstrLaborAlive\" value=\""+MATObstrLaborAlive+"\" autocomplete=\"off\"  onblur=\"autosave('MATObstrLaborAlive');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
                   + "<td ><input type=\"text\" name=\"MATObstrLaborDead\" id=\"MATObstrLaborDead\" value=\""+MATObstrLaborDead+"\" autocomplete=\"off\"  onblur=\"autosave('MATObstrLaborDead');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
              + "<tr>"
               + "   <td>19.</td> <td > Sepsis</td>"
                   + "<td ><input type=\"text\" name=\"MATSepsisAlive\" id=\"MATSepsisAlive\" value=\""+MATSepsisAlive+"\" autocomplete=\"off\"  onblur=\"autosave('MATSepsisAlive');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
                   + "<td ><input type=\"text\" name=\"MATSepsisDead\" id=\"MATSepsisDead\" value=\""+MATSepsisDead+"\" autocomplete=\"off\"  onblur=\"autosave('MATSepsisDead');\" maxlength=\"10\" onkeypress=\"return numbers(event)\" style=\"width: 80px;\"></td>"
              + "</tr>"
             + ""
             + ""
             + "</table></fieldset>"
