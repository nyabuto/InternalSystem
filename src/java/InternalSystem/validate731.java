...
if(mn>=10 && mn<=12){quarter=1;}
if(mn>=1 && mn<=3){quarter=2;}
if(mn>=4 && mn<=6){quarter=3;}
if(mn>=7 && mn<=9){quarter=4;}
...
conn.pst=conn.conn.prepareStatement(copyToTemp);
  ...
  conn.pst.setInt(4 ,pepfaryear); 
    ...
    conn.pst.setString(154 ,"1"); 	
    conn.pst.setString(155 ,yearmonth); 	
    conn.pst.setString(156 ,"0"); 	
    conn.pst.setInt(157 ,quarter); 
