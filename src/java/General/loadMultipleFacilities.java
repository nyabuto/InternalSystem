 ...
 */
public class loadMultipleFacilities extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       //disttrict is same as subcounty
        ...
        try {
            ...
            if(!subcounty.equals("("))
                 {
             getfacils="select SubPartnerID,SubPartnerNom from subpartnera where active='1' and DistrictID in "+subcounty+" order by SubPartnerNom ";
                 }
            else {
