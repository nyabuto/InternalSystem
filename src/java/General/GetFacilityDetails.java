 ...
 */
public class GetFacilityDetails extends HttpServlet {
         ...
         public String getFacilityID(String mflcode, dbConn conn ) throws SQLException 
    {
       ...
       public String getFacilityNameUsingID(String facilityid, dbConn conn ) throws SQLException 
    {
        String id = "";

        String getindicator = "SELECT SubPartnerNom FROM subpartnera where SubPartnerID = '" +facilityid+"'";
