 ...
 * @author Elkant
 */
public class loadSubcountyLen extends HttpServlet {
    ...
    //   System.out.println(" County:"+ county_name); 
       ...
       String districts="Select * from district where CountyID='"+county_id+"' and DistrictID in (select DistrictID from subpartnera where active=1 and lenprep=1 )";
