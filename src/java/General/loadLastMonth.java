               ...
               if(sessionmonth.equalsIgnoreCase(conn.rs.getString("id"))){
                ...
                if (conn.rs.getInt("id") >= 10) {
                    if (prevyear != 0) {
                        ...
                        months += "<option "+selectedopt+" value='" + conn.rs.getString("id") + "'>" + conn.rs.getString("name") + " ," + prevyear + "</option> ";
                    } else {
                        months += "<option "+selectedopt+" value='" + conn.rs.getString("id") + "'>" + conn.rs.getString("name") + "</option> ";
                    }
                } else if (conn.rs.getInt("id") < 10) {

                    if (!passedyear.equals("")) {

                        months += "<option "+selectedopt+" value='" + conn.rs.getString("id") + "'>" + conn.rs.getString("name") + " ," + passedyear + "</option> ";
                                                } 
                    else {
                        months += "<option "+selectedopt+" value='" + conn.rs.getString("id") + "'>" + conn.rs.getString("name") + "</option> ";
                    }
