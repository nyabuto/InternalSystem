 ...
 */
public class getSitesWithHptClients extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(getSitesWithHptClients.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public String GetSitesCount(dbConn conn) throws SQLException{
     String sites="0";
        ...
        String qr="select count(distinct(Facility)) from hpt_audit_list ";
    ...
    public ResultSet GetSites(dbConn conn) throws SQLException{
        ...
        String qr="select Facility ,mflcode ,'' as sub_county,'' as county from hpt_audit_list group by mflcode";
