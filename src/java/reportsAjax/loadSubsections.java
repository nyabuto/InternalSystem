 ...
 * @author Elkant
 */
public class loadSubsections extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String selectforms="select subsectionid as subsectionid, subsection as subsection from pivottable where active='1' and sectionid in "+val+" group by subsectionid";
