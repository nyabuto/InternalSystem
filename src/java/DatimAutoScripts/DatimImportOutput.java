 ...
 * @author EKaunda
 */
public class DatimImportOutput extends HttpServlet {
...
String prd="";
 ...
 if(request.getParameter("prd")!=null)
        {        
...
//______________________________________________________________________________________  
        ...
        sps.put(1, "UTJ_"+prd+"@sp_datimimport");
...
String startdate="2020-04-01";
      ...
      //  XSSFRow rw0=shet.createRow(1);
        ...
        String qry = "call "+storedprocedure+" ('"+prd+"')";
...
rw.setHeightInPoints(32);
        ...
        System.out.println("" + "USAID_Tujenge_Jamii_"+prd+"_DatimImport_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "USAID_Tujenge_Jamii_"+prd+"_DatimImport_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DatimImportOutput.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
