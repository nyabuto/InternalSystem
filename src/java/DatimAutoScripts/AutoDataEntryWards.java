 ...
 */
public class AutoDataEntryWards extends HttpServlet {
...
{    
    ...
    String wd=sites[a];
    String ward_st[]=wd.split("_");
    
    //String wardid=
     prdhm.put("hf", ward_st[1]);
     prdhm.put("hfid", ward_st[0]);
     
     
    System.out.println("Facility:"+ward_st[1]);
   out.println("Facility:"+ward_st[1]+"<br/>"); 
...
//orgUnitVTDmBU47aI4    orgUnit  VTDmBU47aI4
     //System.out.println("After site clear click");
     searchfield.sendKeys(ward_st[1]);
       ...
       //WebElement clicksearch1 = new WebDriverWait(driver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(By.id("orgUnit"+ward_st[0])));
//       driver.findElement(By.id("orgUnit"+ward_st[0])).click();
