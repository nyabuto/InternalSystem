...
int art_male,art_less1,art_1to4,art_5to9,art_10to14,art_15to19,art_20above;
 ...
 female_stat=male_stat=0;
 less1=stat_1to4=stat_5to9=stat_10to14=stat_15to19=stat_20above=positive=negative=0;
 
 art_numerator=art_denominator=art_female=0;
 art_male=art_less1=art_1to4=art_5to9=art_10to14=art_15to19=art_20above=0;
...
// GET DATA FROM THE EXCEL AND AND OUTPUT IT ON THE CONSOLE..................................
  ...
  FileInputStream fileInputStream = new FileInputStream(full_path);
			...
			HSSFSheet worksheet = workbook.getSheet("TB");
...
//                       
  ...
  String inserter="INSERT INTO tb_stat_art (id,SubPartnerID,year,quarter,numerator,denominator,female,male,less1,1to4,5to9,10to14,15to19,20above,positive,negative,art_numerator,art_denominator,art_female,"
                        ...
                        conn.pst.setInt(7, female_stat);
                        conn.pst.setInt(8, male_stat);
                        conn.pst.setInt(9, less1);
                        conn.pst.setInt(10, stat_1to4);
                        conn.pst.setInt(11, stat_5to9);
                        conn.pst.setInt(12, stat_10to14);
                        conn.pst.setInt(13, stat_15to19);
                        conn.pst.setInt(14, stat_20above);
                        conn.pst.setInt(15, positive);
                        conn.pst.setInt(16, negative);
                        conn.pst.setInt(17, art_numerator);
                        conn.pst.setInt(18, art_denominator);
                        conn.pst.setInt(19, art_female);
                        conn.pst.setInt(20, art_male);
                        conn.pst.setInt(21, art_less1);
                        conn.pst.setInt(22, art_1to4);
                        conn.pst.setInt(23, art_5to9);
                        conn.pst.setInt(24, art_10to14);
                        conn.pst.setInt(25, art_15to19);
                        conn.pst.setInt(26, art_20above);
