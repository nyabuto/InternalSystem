 ...
 * @author EKaunda
 */
public class loadTxMl extends HttpServlet {
  ...
  String btn_color = "blue";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String supported_services = " WHERE  is_active=1 && section_name='8.0 ACCOUNTING FOR ART PATIENTS WITH NO CLINICAL CONTACT' &&  ";
...
//         output+="<p id=\"submit_name\">"+submit_button_name+"</p>";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(loadTxMl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
