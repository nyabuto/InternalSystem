 ...
 * @author EKaunda
 */
public class reports_pivot extends HttpServlet {
...
String allpath = getServletContext().getRealPath("/dvt_report.xlsx");
...
String sourcepath = getServletContext().getRealPath("/dvt_report.xlsx");
...
//        //county
      ...
      subcountyar=request.getParameterValues("subcounty"); 
       ...
       // cell.setCellValue("Surge Tracker for Period "+startdate+"  to "+enddate+"");
        ...
        String qry = "call sp_mn_cl_rawdata('"+startdate+"','"+enddate+"','');";
...
((XSSFSheet)shet).getCTWorksheet().getDimension().setRef("A4:T" + (shet.getLastRowNum() + 1));

CTTable ctTable = ((XSSFSheet)shet).getTables().get(0).getCTTable();

ctTable.setRef("A4:T" + (shet.getLastRowNum() + 1)); // adjust reference as needed
        ...
        System.out.println("" + "DataVerification_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "DataVerification_"+startdate+"_to_"+enddate+"_gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(reports_pivot.class.getName()).log(Level.SEVERE, null, ex);
