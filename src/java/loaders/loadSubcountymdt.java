 ...
 * @author Elkant
 */
public class loadSubcountymdt extends HttpServlet {
    ...
    String mdt,current_districts;
    
     mdt=request.getParameter("mdt");
 
    //   System.out.println(" County:"+ county_name); 
       current_districts="";
       
       String districts="Select * from district where DistrictID in ( select DistrictID from subpartnera where mdt='"+mdt+"' and active=1 )";
...
current_districts=current_districts+"<option value=\""+conn.rs.getString("DistrictID")+"\">"+conn.rs.getString("DistrictNom")+"</option>";
    ...
    try {
        ...
        out.close();
            ...
            Logger.getLogger(loadSubcountymdt.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
