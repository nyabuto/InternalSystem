...
//wd
            ...
            String ref_by = "";
            String rec_by = "";
            String reason_no_service_rec = "";
            String other_reason_not_rec = "";

            conn.rs = conn.st.executeQuery(qry);

            while (conn.rs.next()) {

                if (conn.rs.getString("pregnant") != null) {
                    pregnant = conn.rs.getString("pregnant");
                }
                if (conn.rs.getString("clientphone") != null) {
                    clientphone = conn.rs.getString("clientphone");
                }
                if (conn.rs.getString("maritalstatus") != null) {
                    maritalstatus = conn.rs.getString("maritalstatus");
                }
                if (conn.rs.getString("ref_from") != null) {
                    ref_from = conn.rs.getString("ref_from");
                }
                if (conn.rs.getString("ref_to") != null) {
                    ref_to = conn.rs.getString("ref_to");
                }
                if (conn.rs.getString("hivresults") != null) {
                    hivresults = conn.rs.getString("hivresults");
                }
                if (conn.rs.getString("htc_ref") != null) {
                    htc_ref = conn.rs.getString("htc_ref");
                }
                if (conn.rs.getString("htc_ref_date") != null) {
                    htc_ref_date = conn.rs.getString("htc_ref_date");
                }
                if (conn.rs.getString("vmmc_ref") != null) {
                    vmmc_ref = conn.rs.getString("vmmc_ref");
                }
                if (conn.rs.getString("vmmc_ref_date") != null) {
                    vmmc_ref_date = conn.rs.getString("vmmc_ref_date");
                }
                if (conn.rs.getString("anc_pmtct_ref") != null) {
                    anc_pmtct_ref = conn.rs.getString("anc_pmtct_ref");
                }
                if (conn.rs.getString("anc_pmtct_ref_date") != null) {
                    anc_pmtct_ref_date = conn.rs.getString("anc_pmtct_ref_date");
                }
                if (conn.rs.getString("sti_ref") != null) {
                    sti_ref = conn.rs.getString("sti_ref");
                }
                if (conn.rs.getString("sti_ref_date") != null) {
                    sti_ref_date = conn.rs.getString("sti_ref_date");
                }
                if (conn.rs.getString("tb_ref") != null) {
                    tb_ref = conn.rs.getString("tb_ref");
                }
                if (conn.rs.getString("tb_ref_date") != null) {
                    tb_ref_date = conn.rs.getString("tb_ref_date");
                }
                if (conn.rs.getString("familyplanning_ref") != null) {
                    familyplanning_ref = conn.rs.getString("familyplanning_ref");
                }
                if (conn.rs.getString("familyplanning_ref_date") != null) {
                    familyplanning_ref_date = conn.rs.getString("familyplanning_ref_date");
                }
                if (conn.rs.getString("pep_ref") != null) {
                    pep_ref = conn.rs.getString("pep_ref");
                }
                if (conn.rs.getString("pep_ref_date") != null) {
                    pep_ref_date = conn.rs.getString("pep_ref_date");
                }
                if (conn.rs.getString("care_ref") != null) {
                    care_ref = conn.rs.getString("care_ref");
                }
                if (conn.rs.getString("care_ref_date") != null) {
                    care_ref_date = conn.rs.getString("care_ref_date");
                }
                if (conn.rs.getString("psychosocial_ref") != null) {
                    psychosocial_ref = conn.rs.getString("psychosocial_ref");
                }
                if (conn.rs.getString("psychosocial_ref_date") != null) {
                    psychosocial_ref_date = conn.rs.getString("psychosocial_ref_date");
                }
                if (conn.rs.getString("drugabuse_ref") != null) {
                    drugabuse_ref = conn.rs.getString("drugabuse_ref");
                }
                if (conn.rs.getString("drugabuse_ref_date") != null) {
                    drugabuse_ref_date = conn.rs.getString("drugabuse_ref_date");
                }
                if (conn.rs.getString("counselling_ref") != null) {
                    counselling_ref = conn.rs.getString("counselling_ref");
                }
                if (conn.rs.getString("counselling_ref_date") != null) {
                    counselling_ref_date = conn.rs.getString("counselling_ref_date");
                }
                if (conn.rs.getString("bcc_ref") != null) {
                    bcc_ref = conn.rs.getString("bcc_ref");
                }
                if (conn.rs.getString("bcc_ref_date") != null) {
                    bcc_ref_date = conn.rs.getString("bcc_ref_date");
                }
                if (conn.rs.getString("other_ref") != null) {
                    other_ref = conn.rs.getString("other_ref");
                }
                if (conn.rs.getString("other_specific_ref") != null) {
                    other_specific_ref = conn.rs.getString("other_specific_ref");
                }
                if (conn.rs.getString("other_ref_date") != null) {
                    other_ref_date = conn.rs.getString("other_ref_date");
                }
                if (conn.rs.getString("htc_rec") != null) {
                    htc_rec = conn.rs.getString("htc_rec");
                }
                if (conn.rs.getString("htc_rec_date") != null) {
                    htc_rec_date = conn.rs.getString("htc_rec_date");
                }
                if (conn.rs.getString("vmmc_rec") != null) {
                    vmmc_rec = conn.rs.getString("vmmc_rec");
                }
                if (conn.rs.getString("vmmc_rec_date") != null) {
                    vmmc_rec_date = conn.rs.getString("vmmc_rec_date");
                }
                if (conn.rs.getString("anc_pmtct_rec") != null) {
                    anc_pmtct_rec = conn.rs.getString("anc_pmtct_rec");
                }
                if (conn.rs.getString("anc_pmtct_rec_date") != null) {
                    anc_pmtct_rec_date = conn.rs.getString("anc_pmtct_rec_date");
                }
                if (conn.rs.getString("sti_rec") != null) {
                    sti_rec = conn.rs.getString("sti_rec");
                }
                if (conn.rs.getString("sti_rec_date") != null) {
                    sti_rec_date = conn.rs.getString("sti_rec_date");
                }
                if (conn.rs.getString("tb_rec") != null) {
                    tb_rec = conn.rs.getString("tb_rec");
                }
                if (conn.rs.getString("tb_rec_date") != null) {
                    tb_rec_date = conn.rs.getString("tb_rec_date");
                }
                if (conn.rs.getString("familyplanning_rec") != null) {
                    familyplanning_rec = conn.rs.getString("familyplanning_rec");
                }
                if (conn.rs.getString("familyplanning_rec_date") != null) {
                    familyplanning_rec_date = conn.rs.getString("familyplanning_rec_date");
                }
                if (conn.rs.getString("pep_rec") != null) {
                    pep_rec = conn.rs.getString("pep_rec");
                }
                if (conn.rs.getString("pep_rec_date") != null) {
                    pep_rec_date = conn.rs.getString("pep_rec_date");
                }
                if (conn.rs.getString("care_rec") != null) {
                    care_rec = conn.rs.getString("care_rec");
                }
                if (conn.rs.getString("care_rec_date") != null) {
                    care_rec_date = conn.rs.getString("care_rec_date");
                }
                if (conn.rs.getString("psychosocial_rec") != null) {
                    psychosocial_rec = conn.rs.getString("psychosocial_rec");
                }
                if (conn.rs.getString("psychosocial_rec_date") != null) {
                    psychosocial_rec_date = conn.rs.getString("psychosocial_rec_date");
                }
                if (conn.rs.getString("drugabuse_rec") != null) {
                    drugabuse_rec = conn.rs.getString("drugabuse_rec");
                }
                if (conn.rs.getString("drugabuse_rec_date") != null) {
                    drugabuse_rec_date = conn.rs.getString("drugabuse_rec_date");
                }
                if (conn.rs.getString("counselling_rec") != null) {
                    counselling_rec = conn.rs.getString("counselling_rec");
                }
                if (conn.rs.getString("counselling_rec_date") != null) {
                    counselling_rec_date = conn.rs.getString("counselling_rec_date");
                }
                if (conn.rs.getString("bcc_rec") != null) {
                    bcc_rec = conn.rs.getString("bcc_rec");
                }
                if (conn.rs.getString("bcc_rec_date") != null) {
                    bcc_rec_date = conn.rs.getString("bcc_rec_date");
                }
                if (conn.rs.getString("other_rec") != null) {
                    other_rec = conn.rs.getString("other_rec");
                }
                if (conn.rs.getString("other_specific_rec") != null) {
                    other_specific_rec = conn.rs.getString("other_specific_rec");
                }
                if (conn.rs.getString("other_rec_date") != null) {
                    other_rec_date = conn.rs.getString("other_rec_date");
                }
                if (conn.rs.getString("ref_by") != null) {
                    ref_by = conn.rs.getString("ref_by");
                }
                if (conn.rs.getString("rec_by") != null) {
                    rec_by = conn.rs.getString("rec_by");
                }
                if (conn.rs.getString("reason_no_service_rec") != null) {
                    reason_no_service_rec = conn.rs.getString("reason_no_service_rec");
                }
                if (conn.rs.getString("other_reason_not_rec") != null) {
                    other_reason_not_rec = conn.rs.getString("other_reason_not_rec");
                }
            ...
            String data = "<table class= 'table  table-bordered table-responsive' style='width:100%;' > "
            ...
            data += "<tr><td colspan='1'>Referred By</td>"
                    ...
                    + "<td colspan='4'></td>"
                    + "</tr>"
                    + "<tr><td colspan='6'>If client did not receive service after referall , provide reason (s) by ticking the appropriate response</td></tr>"
                    + "<tr><td>Reason Client Did not receive service</td>"
                    + "<td><select onchange='toggle_other_reasons_noservice();' size='11' name='reason_no_service_rec' id='reason_no_service_rec' multiple='true'>" + reasonNoService(reason_no_service_rec) + "</select></td>"
                    + "<td><label style='display:none;' class='other_reason_noservice'>Specify Other Reason client did not receieve any service </label></td>"
                    + "<td><textarea style='display:none;' class='other_reason_noservice'  name='other_reason_not_rec' id='other_reason_not_rec'>" + other_reason_not_rec + "</textarea></td>"
                    + "<td></td><td></td></tr>"
                    + //______________________________services__________________________________________                    
                    " <tr><td colspan='6'> "
    ...
    public String pregnancyStatus(String curstatus, String Sex) {
        ...
        for (int b = 0; b < allattendance.length; b++) {
            ...
            if (curstatus.equals(allattendance[b])) {
                isselected = " selected ";
            }
            if (Sex.equals("Male")) {
    ...
    public String reasonNoService(String curstatus) {

        String allattendance[] = {"Stigma and discrimination", "Self -fear", "Cultural beliefs", "Religious beliefs", "Distance", "Lack of time", "Self transfer", "Long queue at facility", "Service not available", "No service provider ", "Other reasons (specify)"};
        ...
        for (int b = 0; b < allattendance.length; b++) {
            String isselected = "";
            //System.out.println(" Compare statuses "+curstatus+"  "+allattendanceid[b]);
            if (curstatus.contains("," + ids[b] + ",")) {
                isselected = " selected ";
            }

            options += "<option " + isselected + " value='" + ids[b] + "'>" + ids[b] + ". " + allattendance[b] + "</option>";
