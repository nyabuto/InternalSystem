 ...
 */
public class getSitesWithNonStandardCccNos extends HttpServlet {
    ...
    public String GetSitesCount(dbConn conn) throws SQLException{
     String sites="0";
        ...
        String qr="select count(distinct(facility)) from vl_for_cleaning ";
    ...
    public ResultSet GetSites(dbConn conn) throws SQLException{
        ...
        String qr="select facility,facility_code,sub_county,county from vl_for_cleaning group by facility_code";
