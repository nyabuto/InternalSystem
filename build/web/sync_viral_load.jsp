               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  SYNC VIRAL LOAD REPORTS</h4>
                       
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="syncviralload" id="formActions" class="form-horizontal">
...
<h4 id="msg" style="color:green;margin-left: 160px;font-family: cambria;">Note:  This section is used to sync viral load data from raw form into a Datim format for report generation.<br/>After uploading the raw data, always select the year and quarter of the data that you want to sync. </h4>
                           </div>
                        </form>
                        <!-- END FORM-->           
                     </div>
                ...
                session.removeAttribute("upload_success");
                        ...
                        <script>
                            ...
                            // this will prevent from submitting the form.
                             ...
                             $("#msg").html("Syncing data ...Please wait"); 
                                
                            var yr=$("#year").val();
                            var qtr=$("#quarter").val();
                            $.ajax({
                                url:"syncviralload?year="+yr+"&quarter="+qtr,
                                type:'post',
                                dataType:'html',
                                success: function(data){
