...
<head>
   <meta charset="utf-8" />
   <title>DATIM VERIFICATION DATA REPORT.</title>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                        <a href="#" style="margin-left:40%;">IMIS VERIFICATION DATIM DATA REPORTS.</a> 
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="verificationreports" id="formActions" class="form-horizontal">
