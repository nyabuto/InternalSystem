               ...
               <div class="span12">
                  ...
                  <ul class="breadcrumb" >
                   ...
                   <%if (session.getAttribute("addUser") != null) { %>
                    ...
                    var n = noty({text: '<%=session.getAttribute("addUser")%>',
                        layout: 'center',
                        type: 'Success',
                ...
                session.removeAttribute("addUser");
                  ...
                  <!-- BEGIN SAMPLE FORM--> 
                  <form action="addUsers" method="post" class="form-horizontal" style="min-height: 450px;">
  ...
  <br>
    <table style="margin-left: 200px;">  
      <tr>
       ...
       <td style="padding-left: 200px;"><input type="text" name="fname" id="fname" class="textbox" placeholder="" maxlength="30" autocomplete="off" style="height:25px;" required></td>
      </tr> 
      <tr style="height: 10px;"></tr>
      <tr>
       <td><p style="font-family: lucida calligraphy">Enter middle name <font color="red"></font> :  </p></td>  
         
       <td style="padding-left: 200px;"><input type="text" name="mname" id="mname" class="textbox" placeholder="" autocomplete="off" maxlength="30" style="height:25px;"> </td>
      </tr>
      <tr style="height: 10px;"></tr>
      <tr>
      ...
      <tr>
       ...
       <td style="padding-left: 200px;"><input type="text" name="username" id="username" class="textbox" placeholder="" autocomplete="off" maxlength="30" style="height:25px;" required> </td>
      </tr>
      <tr style="height: 10px;"></tr>
      <tr>
      ...
      <tr style="height: 10px;"></tr>
      <tr>
       <td><p style="font-family: lucida calligraphy">Choose access level <font color="red">*</font> : </p> </td>  
         
       <td style="padding-left: 200px;">
           <select name="level" id="level" required="true" style="width:200px;">
      ...
      <tr>
          <td></td>
       <td colspan=""><input type="submit" class="btn blue" value="Save"> </td>  
