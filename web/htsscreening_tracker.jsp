   ...
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="navbar-inner">
         <div class="container-fluid">
            <!-- BEGIN LOGO -->
            <h2 style="text-align:center;font-size: 20px;color:white;padding-bottom:16px ;font-weight: bolder;">Download Sites with Missing/Incomplete  HTS Screening Tracker </h2><br/>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                        <a href="#" style="margin-left:40%;">Download Hts Screening Tracker</a> 
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="downloadHTSScreeningTracker" method="post" enctype="multipart/form-data" class="form-horizontal" >
                            ...
                            %>
                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
                                  ...
                                  <input required type="text" title="this is the period start date" value="<%=ig.LastMonthDate()%>" class="form-control input-lg tarehe" name="startdate" id="startdate" autocomplete="off">
                            </div>
                           </div>
