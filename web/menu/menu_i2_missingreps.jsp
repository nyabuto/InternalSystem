...
<a   style="margin: 5px;" href="fptwebtracker.jsp" class="btn btn-light"><img style="width:100px;" src="./images/icons/fpt.png" class="img img-circle" /><i class="feather icon-clock"></i> FPT Web Tracker</a>
<a   style="margin: 5px;" href="htsscreening_tracker.jsp" class="btn btn-light"><img style="width:100px;" src="./images/icons/hts_screening.png" class="img img-circle" /><i class="feather icon-clock"></i> HTS Screening Tracker</a>
<a   style="margin: 5px;" href="TXML_Tracker.jsp" class="btn btn-light"><img style="width:100px;" src="./images/icons/tx_ml.png" class="img img-circle" /><i class="feather icon-clock"></i> TX_ML Submission Tracker</a>
<a   style="margin: 5px;" href="aca_mca_reports.jsp" class="btn btn-light"><img style="width:100px;" src="./images/icons/hca.png" class="img img-circle" /><i class="feather icon-clock"></i> HCA/ACA/MCA Submission Tracker</a>
<a   style="margin: 5px;" href="jmw_tracker.jsp" class="btn btn-light"><img style="width:100px;" src="./images/icons/jmw.png" class="img img-circle" /><i class="feather icon-clock"></i> JMW Submission Tracker</a>
<a   style="margin: 5px;" href="DQA_Reports.jsp" class="btn btn-light"><img style="width:100px;" src="./images/icons/verification.png" class="img img-circle" /><i class="feather icon-clock"></i> Data Verification Reports and Tracker</a>
