...
<ul>
     ...
     <br/>
            ...
            <li class="has-sub ">
               ...
               <ul class="sub">
                  ...
                  <li >  <a href="uploadf1a.jsp"><i class="icon-upload"></i>Upload Form 1A (7.0.1)</a></li>
                  <!--<li >  <a href="uploadf1av51.jsp"><i class="icon-upload"></i>Upload Form 1A (v 5.0.1)</a></li>-->
            ...
            <li class="has-sub ">
             ...
             <li class="has-sub ">
               ...
               <li >   <%if(session.getAttribute("userAccess")!=null){%>   
                  <a href="hcaupload.jsp"><i class="icon-upload"></i>Upload HCA</a>
                   <%} else {%> 
     ...
     <%if(session.getAttribute("userAccess")!=null){if(session.getAttribute("userAccess").toString().contains(",maintenance,")){%> 
                 ...
                 <li> <a href="afyastat_verification.jsp"><i class="icon-upload"></i>Refresh Afyastat Data Sources</a></li>
             ...
             <%if(session.getAttribute("userAccess")!=null){if(session.getAttribute("userAccess").toString().contains(",uploads,")){%> 
               ...
               <span class="arrow "></span>
                ...
                <ul class="sub">
                  ...
                  <li ><a href="uploadVL_Surge.jsp"><i class="icon-plus"></i>Viral Load raw- Nascop Website</a></li>
            ...
            <li  class="has-sub">
               ...
               <span class="title">EMR Status</font></span>
               </a>
