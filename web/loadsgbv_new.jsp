               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="validatesgbv_new" class="form-horizontal">
...
var achieved=document.getElementById(col).value;
             ...
             $.ajax({
url:'savesgbv_new?col='+col+"&achieved="+achieved,
type:'post',
dataType:'html',
success:function (data){
...
return true;
    ...
    for(b=0;b<sourceindicatorsarray.length;b++){
        //check if there
        if($("#"+sourceindicatorsarray[b]).val()!=='' && $("#"+sourceindicatorsarray[b]).val()!=null){
