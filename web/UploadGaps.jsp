<%-- 
    Document   : UploadGaps
    Created on : Mar 26, 2018, 10:06:29 AM
    Author     : GNyabuto
--%>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                        <a href="#" style="margin-left:40%;">Load Gaps.</a> 
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4 style="text-align:center;"><i class="icon-reorder"></i> Uploading Gaps</h4>
                       
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="LoadGaps" method="post" enctype="multipart/form-data" class="form-horizontal" style="margin: 0px 300px 0 300px">
                        <table >
                        ...
                        <div class="form-actions">
                            ...
                            <br><br>
                              <table border="1" style="width: 100%;"><tr>
                                      ...
                                      <td>Rule</td><td>Gap</td><td>Program Area</td><td>County</td><td>Sub County</td><td>Facility</td><td>Year</td><td>Month</td><td>Ward</td><td>Latitude</td><td>Longitude</td>
...
<script > 
 ...
 <%if (session.getAttribute("gaps") != null) { %>
  ...
  message:'<%=session.getAttribute("gaps")%>'},
      {
	icon_type: 'image'
      }, 
      {
