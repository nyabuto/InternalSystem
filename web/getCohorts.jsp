...
<head>
   <meta charset="utf-8" />
   <title>Download ACA/MCA Template</title>
...
<!--                 <div class=\"notifications top-left"><a href="#" class="close" data-dismiss="alert"></a> here we are</div>
                 -->
                  ...
                  <form action="downloadacamcatemplate" method="post" class="form-horizontal" style="min-height: 450px;">
                      <br/>
                      ...
                      <br/>
                    <%if(session.getAttribute("userAccess")!=null){} else {%>   <h4 class='btn-block btn-warning btn-lg' style='text-align:center;color:black;'> Please <a href="index.jsp" class="btn-info btn-lg "><b>Login</b></a> using your ACA Credentials in order to access the Upload module </h4>
                      <br/>
                      <%}%>
                      <div>  
