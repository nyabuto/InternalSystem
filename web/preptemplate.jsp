...
<head>
   <meta charset="utf-8" />
   <title>Download Prep Template</title>
...
<!-- Modal -->
                         ...
                         <!--<i class="icon-home"></i>-->
                        <b >Download Prep  reporting Template <font color='green'>(Partner Performance, Prep Utilization in PMTCT, Prep Retention and Continuation )</font></b>
...
<!--                 <div class=\"notifications top-left"><a href="#" class="close" data-dismiss="alert"></a> here we are</div>
                 -->
                  ...
                  <form action="downloadPrepTemplate" method="post" class="form-horizontal" style="min-height: 450px;">
                      <br/>
