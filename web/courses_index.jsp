...
<!--===============================================================================================-->
      ...
      <%if (session.getAttribute("courses_login") != null) { %>
                                <script type="text/javascript"> 
                    
                    var n = noty({text: '<%=session.getAttribute("courses_login")%>',
                        layout: 'center',
                        type: 'Success'});
                    
                </script> <%
                session.removeAttribute("courses_login");
                            }
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-3 p-b-20">
				<form action='courses_login' class="login100-form validate-form">
					<h3 style="text-align: center;">Courses Completion Updates</h3>
                                        <hr>
					<span class="login100-form-avatar">
                                            <img src="images/courses.png" alt="welcome">
					</span>
