   ...
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="navbar-inner">
         <div class="container-fluid">
            <!-- BEGIN LOGO -->
            <h2 style="text-align:center;font-size: 30px;color:white;padding-bottom:16px ;font-weight: bolder;">Afyastat Verification</h2><br/>
                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
                                  <select required type="text" title="" onchange='selectoutput();'  class="form-control input-lg" name="outiput" id="outiput" >
                                       ...
                                       <option value='sp_fas_insert_into_emrverification_'>Refresh IMIS, KHIS Data</option>
...
function getReport()
{
  ...
  function downloadrpt(startdate,enddate){
               ...
               var urel=$("#outiput").val();
                ...
                var ur="runStoredProcedure";
 console.log(ur);
 
 $.ajax({
     url: ur,
     dataType: 'html',
     data: {sp:urel,startdate:enddate,enddate:enddate},
