<%-- 
    Document   : Upload_CXCA
    Created on : Oct 8, 2018, 4:58:54 PM
    Author     : GNyabuto
--%>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div  style="text-align: center; font-weight: 900; padding: 20px 0 40px 0;">
                         <div style="float: left; font-size: 30px; margin-left: 20%; color:#ffffff;">Cervical Cancer Screening & Treatment [.XLSX]</div> <div style=" margin-left: 60px; float:left; text-align: center; color:black ;font-family: cambria;">Last Updated: 2018-10-09 09:12am </div>
                     </div>
                     ...
                     <div class="portlet-body form"  id="upload_area">
                        <!-- BEGIN FORM-->
                        <form action="Upload_CXCA" method="post" enctype="multipart/form-data" class="form-horizontal" >
                    ...
                    <br>
                     ...
                     <div class="form-actions scrollmenu">
                               <button type="submit" class="btn blue" style=" float: left;">Load CXCA Excel.</button>
                           </div>
                        <div class="form-actions scrollmenu">
...
//        alert("data submitted");
     ...
     function load_records(){
             $.ajax({
        url:'check_status?load_type=cxca',
        type:"post",
        dataType:"json",
...
var message = "["+per_value+"%] Complete "+response.message+" Records Scanned";
 ...
 <%if (session.getAttribute("cxca_uploaded") != null) { %>
  ...
  message:'<%=session.getAttribute("cxca_uploaded")%>'},
      {
	icon_type: 'image'
      }, 
      {
