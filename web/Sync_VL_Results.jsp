...
<head>
   <meta charset="utf-8" />
   <title>VL Reports Syncing</title>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                        <a href="#" style="margin-left:40%;">Sync VL Results</a> 
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="vl_txcurr_txpvls" method="post" enctype="multipart/form-data" class="form-horizontal" >
