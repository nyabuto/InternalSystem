...
<head>
   <meta charset="utf-8" />
   <title>Load TB Excel Data.</title>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="loadTBExcel" method="post" enctype="multipart/form-data" class="form-horizontal" >
...
%>
 ...
 <%if (session.getAttribute("upload_success") != null) { %>
      ...
      $.notify('<%=session.getAttribute("upload_success")%>', {
	offset: {
		x: 600,
		y: 300
	}
