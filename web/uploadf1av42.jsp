               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  UPLOAD Form 1A V 3.1.0  (.xlsx)</h4>
                       
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="uploadf1av42" id="formActions" method="post" enctype="multipart/form-data" class="form-horizontal">
