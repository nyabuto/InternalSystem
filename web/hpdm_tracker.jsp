   ...
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="navbar-inner">
         <div class="container-fluid">
            <!-- BEGIN LOGO -->
            <h2 style="text-align:center;font-size: 20px;color:white;padding-bottom:16px ;font-weight: bolder;">HPDM Reports Tracker</h2><br/>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                        <a href="#" style="margin-left:40%;">Pull a list of Sites with unsubmitted HPDM Reports</a> 
                            ...
                            %>
                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
                                  ...
                                  <input required type="text" title="Reporting Start Date" value="<%=ig.LastMonthStartDate()%>" class="form-control input-lg tarehe" name="startdate" id="startdate" autocomplete="off">
                              </div>
                           </div>
