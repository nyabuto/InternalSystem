<%-- 
    Document   : IMIS_DHIS_Variances
    Created on : Jul 10, 2018, 12:25:52 PM
    Author     : GNyabuto
--%>
...
<head>
   <meta charset="utf-8" />
   <title>DHIS-IMIS Variance Report</title>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4 style="color:white;"> <i class="icon-reorder"></i>  <span style="text-align: center;">IMIS - DHIS Variance Comparison Report</span></h4>
                       
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="DHIS_IMIS_Variance_Output" class="form-horizontal">
...
%>
     ...
     <h4 class="portlet-title" style="text-align: center;color:black;"> &copy; Tujenge Jamii | USAID <%=year%>. Host Name :<b><i> <%=conn.dbsetup[0]%></i></b> &nbsp;   Database Name :<i> <%=conn.dbsetup[1]%></i></h4>
