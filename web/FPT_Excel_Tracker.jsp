<%-- 
    Document   : Form1A_Tracker
    Created on : Apr 5, 2019, 12:27:36 PM
    Author     : GNyabuto
--%>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                        <a href="#" style="margin-left:40%;"><b>FPT Reports Tracker.</b></a> 
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="FPT_excel_tracker" id="" class="form-horizontal">
                           ...
                           <div class="control-group" id="reportSemi">
                            ...
                            <div class="control-group" id="reportMonth">
                              ...
                              <div class="controls">
                                  <select data-placeholder="Reporting Month" onchange="reportsready();" multiple="" class="span6 m-wrap" tabindex="-1"  id="month" name="month" style="width: 400px;">
                            ...
                            <div class="control-group" id="reportMonth">
                              ...
                              <div class="controls">
                                <select  name="county" id="county" multiple="true" class="form-control" style="width: 400px;"> 
                                    <!--<option value="">Choose County</option>-->  
                                </select>
                              </div>
                           </div>
                            <div class="control-group" id="reportMonth">
                              <label class="control-label">Sub County<font color='red'><b></b></font></label>
                              <div class="controls">
                                  <select  name="district" id="district" multiple="true" class="form-control" style="width: 400px;"> 
                                    <!--<option value="">Chose Sub County</option>-->  
                                </select>
                              </div>
                           </div>
                            <div class="control-group" id="reportMonth">
                              <label class="control-label">Health Facility (ies)<font color='red'><b></b></font></label>
                              <div class="controls">
                                 <select  name="facility" id="facility" multiple="true" class="form-control" style="width: 400px;"> 
                           ...
                           <div class="form-actions">
                               <button type="submit" class="btn blue" onmouseover="getAction();">Generate FPT Tracker</button>
                           </div>
                        </form>
                        <!-- END FORM-->           
                     </div>
