                     ...
                     <div class="portlet-body form">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal" >
                             ...
                             <div class="control-group">
                              <label class="control-label">Wards<font color='red'><b>*</b></font></label>
                              <div class="controls">
                           ...
                           <input value="<%=ig.LastQuarterEndDate(ig.CurrentMonthEndDate())%>" required type="text" title=""  class="form-control input-lg" name="edate" id="edate" />
                             ...
                             <div class="control-group" >
                              ...
                              <div class="controls">
                                  <select multiple size="6"  required type="text" title="" onchange="selectoutput();loadDataToElement('getDatimCommunityIndicators','specificform','no','','outiput');"  class="form-control input-lg" name="outiput" id="outiput" >
...
function loadDataToElement(act,element,issearchselect,firstoption,sourceoffilter)
{
  ...
  loadDataToElement('getDatimWards','sites','no','','');
  loadDataToElement('getDatimCommunitySections','outiput','no','','');
  loadDataToElement('getDatimCommunityIndicators','specificform','no','','outiput');
