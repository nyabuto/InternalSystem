 ...
 <!--<div class="col-sm-12">-->
        ...
        <div class="col-md-6 col-xl-6">
                <div class="card">
                    <div class="card-header">
                          <h6 class='btn-info' style="text-align:center;padding:4px;">HIV Testing Monthly Trends</h6>
                    </div>
                    <div class="card-body">
                        <div class="ap_hts_tst_trends"></div>
                    </div>
                </div>
            </div>    
            ...
            <div class="col-md-6 col-xl-6">
                <div class="card">
                    <div class="card-header">
                            ...
                            <h6 class='btn-info' style="text-align:center;padding:4px;">HIV Positive Monthly Trends</h6>
                    </div>
                    <div class="card-body">
                        <div class="ap_hts_tst_pos_trends"></div>
                    </div>
                </div>
            </div> 
            </div>
     ...
     <div class="col-xl-6 col-md-12">
            <div class="card User-Activity table-card">
              <div class="card-header">
                <h6 class='btn-info' style="text-align:center;padding:4px;">HIV Testing By Region</h4>
              </div>
              <div class="card-body p-0">
                <div class="table-responsive">
                  ...
                  <div class="activity-scroll" style="width:100%;">
                     ...
                     <table class="table table-sm  ap_hts_tst_summary">
                        <td>
     ...
     <div class="col-xl-6 col-md-12">
            <div class="card User-Activity table-card">
              <div class="card-header">
                <h6 class='btn-info' style="text-align:center;padding:4px;">HIV Positive By Region</h4>
              </div>
              <div class="card-body p-0">
                <div class="table-responsive">
                  ...
                  <div class="activity-scroll" style="width:100%;">
                     ...
                     <table class="table table-sm  ap_hts_tst_pos_summary">
                        <td>
                            <div class="d-flex justify-content-center">
                                <div class=" spinner-border" role="status">
                                    <span class="sr-only">Loading...</span>
