                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
                                  <select required type="text" title="" onchange='selectoutput();'  class="form-control input-lg" name="output" id="output" >
                                       ...
                                       <option value='sp_vl_insertkenyaemr'>Refresh KenyaEMR</option>
                                       <option value='sp_vl_insert_nonemrvl'>Refresh VLMIS</option>
                                       <option value='sp_vl_insertwebsite_deduplicated'>Refresh VL Website</option>
