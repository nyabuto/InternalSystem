...
<head>
   <meta charset="utf-8" />
   <title>EMR Status Reports</title>
   ...
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="navbar-inner">
         <div class="container-fluid">
            <!-- BEGIN LOGO -->
            <h2 style="text-align:center;font-size: 50px;color:white;padding-bottom:16px ;font-weight: bolder;">EMR Status Report</h2><br/>
...
<!--                                      <option value='Missng_EMR_status'>Tracker</option>-->
                                       <option value='reportEmrStatus'>Raw Data</option>
