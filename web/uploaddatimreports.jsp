               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  UPLOAD DATIM FAVORITE REPORTS</h4>
                       
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="DATIM_IMIS" id="formActions" method="post" enctype="multipart/form-data" class="form-horizontal">
                           ...
                           <div class="control-group" >
                              <label class="control-label">Datim report<font color='red'><b>*</b></font></label>
                              <div class="controls">
                                 <input data-placeholder="Reporting Month" type="file" class="span6 m-wrap" tabindex="-1"  id="month" name="month" style="width: 400px;"/>
