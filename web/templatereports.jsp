...
<head>
   <meta charset="utf-8" />
   <title>IMIS Template Reports</title>
   ...
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="navbar-inner">
         <div class="container-fluid">
            <!-- BEGIN LOGO -->
            <h2 style="text-align:center;font-size: 30px;color:white;padding-bottom:16px ;font-weight: bolder;">Template Reports</h2><br/>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                        <a href="#" style="margin-left:40%;">Template Reports</a> 
                        ...
                        <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal" >
                          ...
                          <div class="control-group">
                              ...
                              <div class="controls">
                                  ...
                                  <input required type="text" title="this is the date that the week ended" value="<%=ig.LastMonthStartDate()%>" class="form-control input-lg tarehe" name="startdate" id="startdate" autocomplete="off">
                              </div>
                           </div>
                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
                                  <select required type="text" title="" onchange='selectoutput();'  class="form-control input-lg" name="outiput" id="outiput" >
                                       ...
                                       <option value='micarev2'>Micare Reports</option>
                                       <option value='liftupmicareanalysis'>Micare and Lift Up Analysis Reports</option>
