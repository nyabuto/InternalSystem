               ...
               <div class="span12">
                  ...
                  <div class="portlet box ">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="update_vl_results" method="post" enctype="multipart/form-data" class="form-horizontal" />
            ...
            <td class="col-xs-4">
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                  ...
                                  <input data-date-end-date="0d" required type="text" title="this is the date that the week started" value="<%=ly%>" class="form-control input-lg tarehe" name="sdate" autocomplete="off" id="weekstart">
                              </div>
                           </td>
                           </tr>
                            <tr class="col-xs-8">
                      ...
                      <td class="col-xs-4">
                              <div class="controls">
                                  <input data-date-end-date="0d" required type="text"  title="this is the date that the week ended" value="<%=ig.LastMonthEndDate() %>" class="form-control input-lg tarehe" name="edate" id="weekend" autocomplete="off">
                              </div>
                           </div>
                              </td>
                            </tr>
...
<tr class="col-xs-8">
  ...
  <input type="submit" id="generaterpt" value="AutoUpdate" class="btn green" />
