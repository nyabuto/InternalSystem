   ...
   // $("#addrow").on("click", function () {
      function addrow(){
        ...
        var cols = "<td class= 'col-sm-1 '>"+counter+"<input value='<%=gp.RandomNo(1000, 90000)%>' type='hidden' id='id"+counter+"' name= 'id"+counter+"'  /></td>";
         ...
         cols += "<td class= 'col-sm-2 '><input type= 'text' id='firstname"+counter+"' name= 'firstname"+counter+"' class= 'form-control' /></td>"
         cols += "<td class= 'col-sm-2 '><input placeholder='optional' type= 'text' id='middlename"+counter+"' name='middlename"+counter+"' class= 'form-control' /></td>"
         cols += "<td class= 'col-sm-2 '><input type= 'text' id='lastname"+counter+"' name='lastname"+counter+"' class= 'form-control' /></td>"
         cols += "<td class= 'col-sm-2 '><input type= 'text' id='age"+counter+"' name='age"+counter+"' class= 'form-control' /></td>"
         cols += "<td class= 'col-sm-2 '><select  id='sex"+counter+"' name='sex"+counter+"' class= 'form-control' ><%=gp.getGender("")%></select></td>"
         cols += "<td><input onclick='deleterow(\"tablerow"+counter+"\");' type='button' class='ibtnDel btn btn-md btn-danger' value='Delete'></td>";
         console.log(cols);
        newRow.append(cols);
       // newRow.append("</tr>");
