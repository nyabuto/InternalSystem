    ...
    setTimeout(function() {
        ...
        $(function() {
            var options = {
                ...
                colors: ["#1abc9c"],
                series: [{
                    name: "Bintis Enrolled",
                    data: [10, 41, 35, 51, 49, 62, 69, 91, 148]
                }],
                title: {
                    text: 'Bintis Enrolment by Month',
                    align: 'center'
                },
                grid: {
                    row: {
         ...
         $(function() {
            var options = {
                ...
                title: {
                    text: 'Bintis Follow Up by Month',
                    align: 'center'
                },
                grid: {
                    row: {
         ...
         $(function() {
            var options = {
                ...
                title: {
                    text: 'Binti Follow Ups By Month',
                    align: 'center'
                },
                grid: {
                    row: {
		...
		$(function() {
            var options = {
                ...
                labels: ['Unknown HIV', 'HIV +ve', 'HIV -ve'],
                series: [44, 11, 45],
                colors: ["#1abc9c", "#ff0000", "#00acc1"],
                legend: {
                    show: true,
                    position: 'bottom',
                },
