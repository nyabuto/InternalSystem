<%-- 
    Document   : Upload_PrePNew
    Created on : Oct 15, 2018, 4:44:35 PM
    Author     : GNyabuto
--%>
...
<head>
   <meta charset="utf-8" />
   <title>CXCA Data Upload Module.</title>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div  style="text-align: center; font-weight: 900; padding: 20px 0 40px 0;">
                         <div style="float: left; font-size: 30px; margin-left: 20%; color:#ffffff;">PREP NEW DATA [.XLSX]</div> <div style=" margin-left: 60px; float:left; text-align: center; color:black ;font-family: cambria;">Last Updated: 2018-10-09 09:12am </div>
                     </div>
                     ...
                     <div class="portlet-body form"  id="upload_area">
                        <!-- BEGIN FORM-->
                        <form action="UploadPrepNew" method="post" enctype="multipart/form-data" class="form-horizontal" >
                    ...
                    <br>
                     ...
                     <div class="form-actions scrollmenu">
                               <button type="submit" class="btn blue" style=" float: left;">Load Prep New Excel.</button>
                           </div>
                        <div class="form-actions scrollmenu">
...
//        alert("data submitted");
     ...
     function load_records(){
             $.ajax({
        url:'check_status?load_type=prep_new',
        type:"post",
        dataType:"json",
...
var message = "["+per_value+"%] Complete "+response.message+" Records Scanned";
 ...
 <%if (session.getAttribute("prep_new_uploaded") != null) { %>
   <script type="text/javascript"> 
                    
         $.notify(
      {icon: "images/validated.jpg", 
  message:'<%=session.getAttribute("prep_new_uploaded")%>'},
      {
	icon_type: 'image'
      }, 
      {
	offset: {
		...
		y: 120
                ...
                <%
                session.removeAttribute("prep_new_uploaded");
                            }
