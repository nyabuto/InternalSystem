               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  UPLOAD Form 1A (v 5.0.0.xlsx)</h4>
                     </div>
                  ...
                  <div  class="portlet-body form" id="progress_area" hidden="true">
                     ...
                     <div id="upload_area" class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="uploadf1av50" id="formActions" method="post" enctype="multipart/form-data" class="form-horizontal">
