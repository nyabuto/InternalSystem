...
<head>
   <meta charset="utf-8" />
   <title>Upload Prep Template</title>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  UPLOAD Prep Template (.xlsx)</h4>
                     </div>
                  ...
                  <div  class="portlet-body form" id="progress_area" hidden="true">
                     ...
                     <div id="upload_area" class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="uploadPrep" id="formActions" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <!--<form action="fas_trial" id="formActions" method="post" enctype="multipart/form-data" class="form-horizontal">-->
                          
                        <div class="control-group " ></div>
                           <div  class="control-group col-lg-12" >
                              <label class="control-label col-lg-6">Select Filled Prep excel file<font color='red'><b>*</b></font></label>
    ...
    <br/><b>Excel file(s) with Errors will not go through the upload process </b>.</h5>
                  ...
                  <div id="table_output">
                      <div>
                          ...
                          <br>
                          <div>
                              <div style=" color:red; text-align: center; font-size: 20px; font-family: bolder; ">Data Upload Errors Detected. Form below(s) not uploaded</div>
...
//        alert("data submitted");
     ...
     {
             $.ajax({
        url:'check_status?load_type=prep',
        type:"post",
        dataType:"json",
