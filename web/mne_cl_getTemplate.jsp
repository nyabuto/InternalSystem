...
<head>
   <meta charset="utf-8" />
   <title>Download Data Verification Template</title>
...
<!-- Modal -->
                         ...
                         <!--<i class="icon-home"></i>-->
                        <b >Download Data Verification Monthy reporting Template</b>
...
<!--                 <div class=\"notifications top-left"><a href="#" class="close" data-dismiss="alert"></a> here we are</div>
                 -->
                  ...
                  <form action="downloadDVTemplate" method="post" class="form-horizontal" style="min-height: 450px;">
                      <br/>
