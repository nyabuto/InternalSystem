...
<head>
   <meta charset="utf-8" />
   <title>Quality Of Care Data Upload</title>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                         <a href="DataCleaner.jsp" style="margin-left:40%;">Upload KenyaEMR data files</a> 
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div  style="text-align: center; font-weight: 900; padding: 20px 0 40px 0;">
                         <div style="float: left; font-size: 30px; margin-left: 20%; color:#ffffff;">Upload Quality Of Care data From KenyaEMR [.XLSX]</div> <div style=" margin-left: 60px; float:left; text-align: center; color:black ;font-family: cambria;"> </div>
                     </div>
                  ...
                  <div  class="portlet-body form" id="progress_area" hidden="true">
                     ...
                     <div class="portlet-body form"  id="upload_area">
                        <!-- BEGIN FORM-->
                        <form action="UploadQOC" method="post" enctype="multipart/form-data" class="form-horizontal" >
                       <input multiple="true" type="file" name="file_name" id="upload" value="" class="textbox" required>   
...
<tr>
<td> [A] vl_kenyaemr_id</td>
<td> [B] AgeYrs</td>
<td> [C] Sex</td>
<td> [D] cccno</td>
<td> [E] HIV_Enrollment_Date</td>
<td> [F] ART_Start_Date</td>
<td> [G] Last_VL</td>
<td> [H] Last_VL_Date</td>
<td> [I] Facility_Name</td>
<td> [J] MFL_Code</td>
<td> [K] Justification</td>
<td> [L] PMTCT</td>
<td> [M] Yearmonth</td>
<td> [N] Last_Visit_Date</td>
<td> [O] Next_appointment_date</td>
<td> [P] Indicator</td>
<td> [Q] regimen_name</td>
<td> [R] regimen_line</td>
<td> [S] Uzito</td></tr>
</table>
...
//        alert("data submitted");
     ...
     function load_records(){
             $.ajax({
        url:'check_status?load_type=emr_viral_load',
        type:"post",
        dataType:"json",
...
var message = "["+per_value+"%] Complete "+response.message+" Records Scanned";
 ...
 <%if (session.getAttribute("emr_vl_loaded") != null) { %>
   <script type="text/javascript"> 
                    
         $.notify(
      {icon: "images/validated.jpg", 
  message:'<%=session.getAttribute("emr_vl_loaded")%>'},
      {
	icon_type: 'image'
      }, 
      {
	offset: {
		...
		y: 120
                ...
                <%
                session.removeAttribute("emr_vl_loaded");
                            }
