               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  UPLOAD Old Form 1A   (.xlsx)</h4>
                       
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="uploadf1av2" id="formActions" method="post" enctype="multipart/form-data" class="form-horizontal">
