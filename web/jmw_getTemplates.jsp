...
<head>
   <meta charset="utf-8" />
   <title>Download JMW Template</title>
...
<!-- Modal -->
                         ...
                         <!--<i class="icon-home"></i>-->
                        <b >Download JMW Monthy reporting Template</b>
...
<!--                 <div class=\"notifications top-left"><a href="#" class="close" data-dismiss="alert"></a> here we are</div>
                 -->
                  ...
                  <form action="downloadJMWTemplate" method="post" class="form-horizontal" style="min-height: 450px;">
                      <br/>
