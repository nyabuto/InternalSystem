<%-- 
    Document   : UploadNewANCData
    Created on : Sep 1, 2017, 1:23:46 PM
    Author     : GNyabuto
--%>
...
<head>
   <meta charset="utf-8" />
   <title>Load New ANC Excel Data.</title>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="LoadNewANC" method="post" enctype="multipart/form-data" class="form-horizontal" style="margin: 0px 300px 0 300px">
                        ...
                        <div class="form-actions">
                            ...
                            <br><br>
                              <table border="1" style="width: 100%;"><tr><td>(0) County</td><td>(1) Sub County</td><td>(2) Facility</td><td>(3) MFL Code</td><td>(4)  New ANC</td><td>(5) Year</td><td>(6) Month</td></tr></table>
