               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  UPLOAD JUA MTOTO WAKO DATA V 1.0.0  (.xlsx)</h4>
                  ...
                  <div  class="portlet-body form" id="progress_area" hidden="true">
                     ...
                     <div id="upload_area" class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="uploadJMW" id="formActions" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <!--<form action="fas_trial" id="formActions" method="post" enctype="multipart/form-data" class="form-horizontal">-->
                          
                        <div class="control-group " ></div>
                           <div  class="control-group col-lg-12" >
                              <label class="control-label col-lg-6">Select Filled JMW excel file<font color='red'><b>*</b></font></label>
