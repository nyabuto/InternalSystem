               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="DatimOutput" id="" class="form-horizontal">
                           ...
                           <div class="control-group" id="reportSemi">
                            ...
                            <div class="control-group" id="reportMonth">
                             ...
                             <div class="control-group" id="reporttype">
                              ...
                              <div class="controls">
                                  <select data-placeholder="Service" class="span6 m-wrap" tabindex="-1"  id="service_area" name="service_area" style="width: 400px;" multiple="true">
                                  </select>
                              </div>
                           </div> 
                            
                             <div class="control-group" id="reporttype">
                              <label class="control-label">Indicators<font color='red'><b></b></font></label>
                              <div class="controls">
                                  <select data-placeholder="Indicators"  class="span6 m-wrap" tabindex="-1"  id="indicators" name="indicators" style="width: 400px;" multiple="true">
                                  </select>
                              </div>
                           </div> 
