               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  SYNC TB DATA</h4>
...
<h4 id="msg" style="color:green;margin-left: 160px;font-family: cambria;">Note:  This section is used to sync tb data from raw form into a Datim format for report generation.<br/>After uploading the raw data, always select the year and quarter of the data that you want to sync. </h4>
                           </div>
                        </form>
                        <!-- END FORM-->           
                     </div>
		...
		y: 300
                ...
                session.removeAttribute("upload_success");
                        ...
                        <script>
                            ...
                            var qtr=$("#quarter").val();
                            $.ajax({
                                url:"synctbdata?year="+yr+"&quarter="+qtr,
                                type:'post',
                                dataType:'html',
                                success: function(data){
