...
<head>
   <meta charset="utf-8" />
   <title>EMR RDQA Data Upload</title>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div  style="text-align: center; font-weight: 900; padding: 20px 0 40px 0;">
                         <div style="float: left; font-size: 30px; margin-left: 20%; color:#ffffff;">Upload RDQA data From KenyaEMR [.XLSX]</div> <div style=" margin-left: 60px; float:left; text-align: center; color:black ;font-family: cambria;"> </div>
                     </div>
                  ...
                  <div  class="portlet-body form" id="progress_area" hidden="true">
                     ...
                     <div class="portlet-body form"  id="upload_area">
                        <!-- BEGIN FORM-->
                        <form action="uploadrdqa" method="post" enctype="multipart/form-data" class="form-horizontal" >
