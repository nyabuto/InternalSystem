<%-- 
    Document   : loadKEPMS
    Created on : Sep 14, 2015, 11:58:51 AM
...
<head>
   <meta charset="utf-8" />
   <title>Load KEPMS ACCESS DATABASE.</title>
...
<!--                    Internal System-->
  ...
  <div id="mergedSuccess" class="alert alert-success">
      <%out.println(session.getAttribute("mergingAccess").toString());%>
</div>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="getKEPMSDATABASE" method="post" enctype="multipart/form-data" class="form-horizontal" >
