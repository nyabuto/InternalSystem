               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  Sites Tracker</h4>
                       
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="sitestracker" id="formActions" class="form-horizontal">
                         ...
                         <!--  <div class="control-group" id="reportFormats" style="display:none;">
                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
                                  ...
                                  <select required data-placeholder="Section" class="span6 m-wrap" multiple="multiple"  tabindex="-1" id="indicator" name="indicator" required  style="width: 400px;">
                                   <!--<option value="">Select section</option>-->   
                                     <%  
                                 dbConn conn = new dbConn();                                 
                                 String getForms="select distinct(indicator) from trackermain order by indicator asc";
                                 conn.rs=conn.st.executeQuery(getForms);
                                 while(conn.rs.next()){
                                 
                             
                                    %>
                                       <option value="<%=conn.rs.getString("indicator")%>"><%=conn.rs.getString("indicator")%></option>                              
                                   <%}%>
                                 </select>
...
<h4 style="color:green;margin-left: 160px;font-family: cambria;"></h4>
                           </div>
                        </form>
                        <!-- END FORM-->           
                     </div>
...
success:function (data){
   ...
   $('#indicator option').prop('selected', true);
                                        });
