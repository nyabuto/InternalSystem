...
<head>
   <meta charset="utf-8" />
   <title>Upload CXCA Section Only</title>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  UPLOAD Form 1A - IPT Section Only (.xlsx)</h4>
                     </div>
                  ...
                  <div  class="portlet-body form" id="progress_area" hidden="true">
                     ...
                     <div id="upload_area" class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="upload_f1a_ipt_only" id="formActions" method="post" enctype="multipart/form-data" class="form-horizontal">
