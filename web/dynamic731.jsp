                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        ...
                        <form action="" name="forms" class="form-horizontal">
                           ...
                           <div class="control-group">
                              <label class="control-label">Select counties<font color='red'><b></b></font></label>
                              <div class="controls">
                                  <select required data-placeholder="select counties" class="span6 m-wrap" tabindex="-1"  id="county" name="county" multiple="true">
                             ...
                             <div class="control-group">
                              <label class="control-label">Select sub-counties<font color='red'><b></b></font></label>
                              <div class="controls">
                                  <select required data-placeholder="select sub counties" class="span6 m-wrap" tabindex="-1"  id="districts" name="districts" multiple="true">
...
<!--                                   <option value="1">Nakuru</option> 
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <select data-placeholder="select facilities" class="span6 m-wrap" required tabindex="-1"  id="facility" name="facility" multiple>
                                    <option value=""></option>
                                 </select>
                              </div>
                           </div>
                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
                                  <select required data-placeholder="select sections" class="span6 m-wrap" tabindex="-1"  id="sectionid" name="sectionid" multiple="true">
...
<!--                                   <option value="1">Nakuru</option> 
                             ...
                             <div class="control-group">
                              <label class="control-label">Select sub-section<font color='red'><b></b></font></label>
                              <div class="controls">
                                  <select required data-placeholder="select sub sections" class="span6 m-wrap" tabindex="-1"  id="sub_sectionid" name="sub_sectionid" multiple="true">
...
//load forms from the pivot table===================
$.ajax({
    url:'loadAllForms',
    type:'post',
    dataType:'html',
...
// alert("counties : "+counties);
 ...
 $.ajax({
    url:'loadDistricts?counties='+counties,
    type:'post',
    dataType:'html',
    success:function (data){
...
$.ajax({
    url:'loadFacils?districts='+districts,
    type:'post',
    dataType:'html',
    success:function (data){
...
$('#sectionid').select2();
 ...
 var form=$("#sectionid").val();
$.ajax({
    url:'loadSubSection?sectionid='+form,
    type:'post',
    dataType:'html',
    success:function (data){

$("#sub_sectionid").html(data);
$('#sub_sectionid').select2();
    }
