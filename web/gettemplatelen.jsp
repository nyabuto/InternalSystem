...
<!--                 <div class=\"notifications top-left"><a href="#" class="close" data-dismiss="alert"></a> here we are</div>
                 -->
                  ...
                  <form action="downloadTemplateLen" method="post" class="form-horizontal" style="min-height: 450px;">
                      <br/>
...
success:function (data){
    ...
    function loadcounty(){
       ...
       function loadsubcounty(){
        ...
        $.ajax({
            url:'loadSubcountyLen?county='+county,
            type:'post',
            dataType:'html',
            success:function (data)
            {
...
$.ajax({
url:'loadMultipleFacilitiesLen?subcounty='+subcounty,
type:'post',
dataType:'html',
success:function (data){
       $("#facility").html(data);
