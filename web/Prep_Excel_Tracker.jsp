   ...
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="navbar-inner">
         <div class="container-fluid">
            <!-- BEGIN LOGO -->
            <h2 style="text-align:center;font-size: 50px;color:white;padding-bottom:16px ;font-weight: bolder;">Consolidated Prep Reports & tracker</h2><br/>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                        <a href="#" style="margin-left:40%;">Generate Prep Tracker and Reports</a> 
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="prepreports" method="post" enctype="multipart/form-data" class="form-horizontal" >
                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
                                  <select required type="text" title="" onchange='selectoutput();'  class="form-control input-lg" name="output" id="output" >
                                      <option value='prepmissingtracker'>Reports Tracker</option>
                                       <option value='prep_analysis_report'>Analysis File</option>
